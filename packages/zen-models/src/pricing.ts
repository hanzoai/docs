...
export const thirdPartyModels = [
  ...
  },
  {
    ...
    contextWindow: 1_000_000,
    pricing: { input: 3.6, output: 18, cacheRead: 0.36, cacheWrite: 4.5 },
  },
  {
    ...
    pricing: { input: 1.2, output: 6, cacheRead: 0.12, cacheWrite: 1.5 },
  },
  {
    name: 'GPT-5',
    ...
    pricing: { input: 1.5, output: 12, cacheRead: 0.15, cacheWrite: null },
  },
  {
    name: 'GPT-5 Mini',
  ...
  },
  {
    ...
    pricing: { input: 0.84, output: 3, cacheRead: null, cacheWrite: null },
  },
  {
    name: 'DeepSeek V3',
