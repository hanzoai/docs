...
import * as __fd_glob_9 from "../content/docs/privacy/index.mdx?collection=docs"
...
import { default as __fd_glob_5 } from "../content/docs/products/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "api/meta.json": __fd_glob_1, "getting-started/meta.json": __fd_glob_2, "privacy/meta.json": __fd_glob_3, "self-hosting/meta.json": __fd_glob_4, "products/meta.json": __fd_glob_5, }, {"index.mdx": __fd_glob_6, "getting-started/index.mdx": __fd_glob_7, "getting-started/quickstart.mdx": __fd_glob_8, "privacy/index.mdx": __fd_glob_9, "api/index.mdx": __fd_glob_10, "products/experiments.mdx": __fd_glob_11, "products/feature-flags.mdx": __fd_glob_12, "products/index.mdx": __fd_glob_13, "products/llm-analytics.mdx": __fd_glob_14, "products/replay.mdx": __fd_glob_15, "products/surveys.mdx": __fd_glob_16, "self-hosting/index.mdx": __fd_glob_17, });