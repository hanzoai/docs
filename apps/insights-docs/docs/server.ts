// @ts-nocheck
import * as __fd_glob_13 from "../content/docs/self-hosting/index.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/products/index.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/products/feature-flags.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "api/meta.json": __fd_glob_1, "getting-started/meta.json": __fd_glob_2, "privacy/meta.json": __fd_glob_3, "products/meta.json": __fd_glob_4, "self-hosting/meta.json": __fd_glob_5, }, {"index.mdx": __fd_glob_6, "api/index.mdx": __fd_glob_7, "getting-started/index.mdx": __fd_glob_8, "getting-started/quickstart.mdx": __fd_glob_9, "privacy/index.mdx": __fd_glob_10, "products/feature-flags.mdx": __fd_glob_11, "products/index.mdx": __fd_glob_12, "self-hosting/index.mdx": __fd_glob_13, });