...
- `insights-sql` — SQL (hanzoai/sql)
- `insights-datastore` — Datastore (hanzoai/datastore)
- `insights-kv` — KV (hanzoai/kv)
...
| SQL | 250m–1 | 512Mi–2Gi | 20Gi |
| Datastore | 500m–2 | 1Gi–8Gi | 50Gi |
| KV | 100m–500m | 256Mi–512Mi | — |
