...
```javascript
insights.init('<YOUR_PROJECT_API_KEY>', {
...
Sessions are stored in your S3 bucket. Default retention is 30 days (configurable). Full-resolution recordings are compressed using LZ-string encoding.
