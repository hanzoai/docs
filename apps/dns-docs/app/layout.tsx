...
export const metadata = createMetadata({
  title: {
    template: '%s | Hanzo DNS',
    default: 'Hanzo DNS - Multi-Tenant DNS Management',
  },
  description: 'Route 53-like DNS management with Cloudflare at edge, CoreDNS as engine, and full console integration.',
