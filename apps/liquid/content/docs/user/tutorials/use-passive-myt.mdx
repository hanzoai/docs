...
<img src="/img/mytYield.png" alt="Passive MYT Yield" class="banner-spacing" />

The Mix-Yield Token turns a single deposit of ETH or UDSC into an auto-compounding position. Once minted, every MYT represents a growing claim on the underlying asset. No extra clicks are required to harvest or reinvest.
