...
export const metadata = createMetadata({
  title: {
    template: '%s | Hanzo Tasks',
    default: 'Hanzo Tasks - Durable Execution for AI Agents',
  },
  description: 'Durable workflow execution engine for AI agent orchestration. Built on Temporal.',
