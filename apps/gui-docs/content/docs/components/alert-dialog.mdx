...
Just [Hanzo GUI Props](/docs/intro/props).

### AlertDialog.Portal

Renders AlertDialog into appropriate container. Beyond [Hanzo GUI Props](/docs/intro/props), adds:
...
Beyond [Hanzo GUI Props](/docs/intro/props), adds:
...
Displays behind Content. Beyond [Hanzo GUI Props](/docs/intro/props), adds:
