...
RadioGroup extends Stack views inheriting all the [Gui standard props](/docs/intro/props), plus:
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'number',
      default: '0.5',
      description: `Scale factor for the radio item size. Hanzo GUI size tokens map to button heights, so you typically want smaller radio buttons.`,
    },
    {
      name: 'unstyled',
      type: 'boolean',
      default: 'false',
      description: `When true, removes all default Hanzo GUI styling.`,
    },
  ]}
/>
