...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'number',
      required: false,
      description: `Override the automatic z-index stacking. By default, Hanzo GUI automatically stacks overlays so later-opened content appears above earlier content. Only set this if you need to override the automatic behavior.`,
    },
  ]}
/>
