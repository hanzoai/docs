...
Hanzo GUI expects for your [font.size](/docs/core/configuration#font-tokens) to have the keys 1-10 so headings work with your font tokens automatically.
...
Headings extend [SizableText props](/docs/components/text#sizabletext) inheriting all the [Gui standard props](/docs/intro/props).
