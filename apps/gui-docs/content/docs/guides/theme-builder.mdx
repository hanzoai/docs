---
title: Creating Themes with Hanzo GUI
description: Learn how to create a suite of themes for a Hanzo GUI app
demoName: ThemeBuilder
---

<IntroParagraph>
  Hanzo GUI themes start simple, but can do some pretty powerful things. To make them easier
