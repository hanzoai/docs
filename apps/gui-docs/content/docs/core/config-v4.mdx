---
title: Quick Config
description: Easy config and themes with @hanzogui/config/v4
---
...
[copy and paste the source code](https://github.com/hanzoai/gui/blob/5b0c075e92688ac85737fe97c98cd77322f034b0/code/core/config/src/v4.ts)
...
default in Hanzo GUI 8. We left it out of Config v4 because
...
- We also are setting `componentThemes` to `defaultComponentThemes`, which will
  generate for us default styling for the Hanzo GUI components. If you prefer
...
Also note that the "true" value on tokens is the "default" - Hanzo GUI for now
uses defaults to determine how to size various things out of the box. This isn't
mandatory, and in version 2 of Hanzo GUI we are working on a more clear solution.
