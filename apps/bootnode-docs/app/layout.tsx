...
export const metadata = createMetadata({
  title: {
    template: '%s | Bootnode Docs',
    default: 'Bootnode - Blockchain Infrastructure Platform',
  },
  description: 'Complete blockchain development platform. Multi-chain RPC, Token API, NFT API, Smart Wallets, Fleet Management, and Infrastructure Services.',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <Body>
        ...
        <Analytics product="bootnode-docs" />
      </Body>
    </html>
  );
}
