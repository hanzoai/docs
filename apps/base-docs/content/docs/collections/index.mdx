...
```bash
# List records
GET /v1/collections/posts/records?page=1&perPage=20&sort=-created

# Filter
GET /v1/collections/posts/records?filter=(status='published')

# Expand relations
GET /v1/collections/posts/records?expand=author

# Get single record
GET /v1/collections/posts/records/RECORD_ID
```
