...
function render(p: Pricing): string {
  ...
  w(
    ...
    "import { Sparkles, Boxes, Key, Code } from 'lucide-react'",
    '',
    '# Pricing',
    '',
  ...
  w(
    ...
    '  <Card icon={<Sparkles />} title="Enso" href="/docs/enso" description="What the three tiers are and how to pick between them." />',
