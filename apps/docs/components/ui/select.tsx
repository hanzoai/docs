...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between gap-2 rounded-lg border px-3 py-2 text-sm',
      'bg-fd-background border-fd-border text-fd-foreground',
      'hover:bg-fd-accent/50 hover:border-fd-ring',
      'focus:outline-none focus:ring-2 focus:ring-fd-ring/40',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-lg border',
        'bg-fd-popover border-fd-border text-fd-popover-foreground shadow-lg',
