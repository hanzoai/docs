...
<Cards>
  ...
  <Card title="Rust" href="/docs/sdks/rust">
    `cargo add hanzo` — async Tokio client. Coming soon (git dependency today).
  </Card>
  ...
  <Card title="Swift" href="/docs/sdks/swift">
    SwiftPM — iOS/macOS client. Coming soon.
  </Card>
...
| **Rust** | Cloud SDK | `cargo add hanzo` | Coming soon |
| **C++** | Cloud SDK | `find_package(hanzo)` | Coming soon |
| **Swift** | Cloud SDK | Swift Package Manager | Coming soon |
