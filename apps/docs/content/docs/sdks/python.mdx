...
The `hanzoai` package is a drop-in replacement for the OpenAI Python SDK, routing requests through the Hanzo LLM Gateway to access all models.
...
client.chat.completions.create(model="groq/llama-4-maverick", ...)
```
