---
title: Python SDK
description: The official Hanzo Python SDK — OpenAI-compatible client for the AI Gateway.
---

# Python SDK

The `hanzoai` package is a drop-in replacement for the OpenAI Python SDK, routing requests through the Hanzo AI Gateway to access all models.
