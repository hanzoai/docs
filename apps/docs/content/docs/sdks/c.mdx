...
The `hanzo-ai` C/C++ library provides native bindings for the Hanzo AI Gateway, designed for low-latency embedded systems, game engines, and performance-critical applications.
