...
<auto-type-table id="example" name="AutoTypeTableExample" type='export interface AutoTypeTableExample {
    ...
    * See https://docs.hanzo.ai/docs/ui/components/type-table
    **/
    name: boolean | null;
...
import { createGenerator, createFileSystemGeneratorCache } from '@hanzo/docs-typescript';
import { AutoTypeTable, type AutoTypeTableProps } from '@hanzo/docs-typescript/ui';
