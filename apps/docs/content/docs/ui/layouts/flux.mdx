...
import { DocsLayout } from '@hanzo/docs-ui/layouts/flux'; // [!code highlight]
...
import { ... } from '@hanzo/docs-ui/layouts/flux/page'; // [!code ++]
```
...
- It is opinionated, use Hanzo Docs CLI for customization instead.
