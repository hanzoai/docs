...
Hanzo Docs use the `<Link />` component of your React framework, and keep their default prefetch behaviours.
...
Handling layout is challenging, Hanzo Docs UI needed an approach that is:
...
Hanzo Docs UI does this with a grid system:
