...
description: "Hanzo Operator is a unified Kubernetes operator that manages all Hanzo production infrastructure declaratively via 7 CRDs under the `hanzo.ai/v1alpha1` API group. Built with Kubebuilder v4 and cont..."
---
...
- Provisioning datastores (SQL, KV, DocumentDB) via HanzoDatastore
