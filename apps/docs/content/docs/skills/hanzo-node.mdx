---
title: "Hanzo Node - Distributed AI Mining & Networking"
description: "Hanzo Node is the foundational infrastructure piece of the Hanzo ecosystem - a Rust-based distributed compute node for privacy-first AI inference, model serving, and network mining."
---
