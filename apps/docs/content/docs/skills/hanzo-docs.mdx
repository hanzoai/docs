...
description: "Hanzo Docs is a multi-brand documentation platform — fork of fumadocs with 27 packages and 15 apps. Serves documentation for Hanzo, Lux, Zoo, and Zen brands from a single monorepo with shared compo..."
---
