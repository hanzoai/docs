...
description: "Hanzo Docs is a multi-brand documentation platform — fork of Hanzo Docs with 27 packages and 15 apps. Serves documentation for Hanzo, Lux, Zoo, and Zen brands from a single monorepo with shared compo..."
---

## Overview

Hanzo Docs is a **multi-brand documentation platform** — fork of Hanzo Docs with 27 packages and 15 apps. Serves documentation for Hanzo, Lux, Zoo, and Zen brands from a single monorepo with shared components and per-brand theming.

**NOTE**: This is a **Hanzo Docs fork** (not a plain Next.js MDX site). It's a monorepo with **27 packages** and **15 apps**, supporting multi-brand documentation (hanzo.ai/docs, docs.lux.network, docs.zoo.ngo, docs.zenlm.org).

### Why Hanzo Docs?

- **Hanzo Docs fork**: Full-featured documentation framework
