---
title: "Hanzo Jin - Visual Self-Supervised Learning Framework"
description: "Jin is a research-stage visual self-supervised learning framework implementing Joint Embedding Predictive Architectures (JEPA)."
---
