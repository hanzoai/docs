...
description: "Hanzo Dataroom is a self-hostable document sharing platform — analytics on every view, custom domains, secure link-based access, and structured data rooms for due diligence. Next.js 15, Prisma on PostgreSQL, Hanzo IAM SSO."
---
