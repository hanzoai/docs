---
title: "Hanzo UI - Component Library (shadcn/ui Fork)"
description: "Hanzo UI is a React component library — 92 primitives plus AI, 3D and commerce components, two themes, multi-framework support and a visual page builder. Published as @hanzo/ui on npm; the CLI is `shadcn`."
---

## Overview

Hanzo UI is a **React component library**: 92 primitives, plus AI, 3D, commerce and animation components, two themes, multi-framework support, and a visual page builder. You own the code — components are copied into your project, not imported from a black box. Published as `@hanzo/ui` v8.0.34 on npm; the CLI is published as `shadcn` v4.1.0.
...
- Using the AI, 3D, animation and commerce components
