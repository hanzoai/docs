---
title: "Hanzo KV"
description: "Hanzo KV is a Redis-compatible in-memory key-value store used as the caching, streaming, and message broker layer across the Hanzo ecosystem. C codebase built with CMake, ships as `ghcr.io/hanzoai/..."
---
...
- **KV drop-in replacement**: Any KV client works out of the box
...
Any KV-compatible client library also works.
