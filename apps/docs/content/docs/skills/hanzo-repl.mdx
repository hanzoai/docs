---
title: "Hanzo REPL"
description: "Hanzo REPL is a Python interactive environment for testing Hanzo MCP tools and AI integration. Three interfaces: a Textual TUI with command palette, an IPython REPL with magic commands, and a basic..."
---
...
User Input
    │
    ├──► REPL Interface (Textual / IPython / Basic)
    │        │
    │        ├──► Direct tool call ──► MCP Server ──► Tool Result
    │        │
    │        └──► Chat message ──► LLM Client (litellm)
    │                                   │
    │                                   ├──► Tool call request
    │                                   │       │
