---
title: "Hanzo Contracts - Legacy Smart Contract Infrastructure"
description: "Hanzo Contracts is a legacy smart contract repository containing 5 infrastructure contracts built with Truffle and Solidity <0.6.0."
---
