---
title: "Hanzo Search - High-Performance Search Engine"
description: "Hanzo Search is a high-performance search engine — a Rust workspace of 23 crates delivering typo-tolerant full-text search, vector and hybrid retrieval, AI ranking, and faceting in sub-50ms across millions of documents."
---
...
- `hanzo/hanzo-database.md` - SQL backend storage
