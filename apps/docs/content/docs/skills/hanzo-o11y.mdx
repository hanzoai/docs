---
title: "Hanzo Observability - Monitoring, Tracing & Error Tracking"
description: "Hanzo Observability covers the full monitoring stack: OpenTelemetry for distributed tracing, Prometheus + Grafana for metrics and dashboards, and Sentry for error tracking."
---
