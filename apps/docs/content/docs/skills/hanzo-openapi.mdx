---
title: "Hanzo OpenAPI"
description: "Hanzo OpenAPI is the canonical OpenAPI 3.1.0 specification for all 69 Hanzo Cloud services. One master spec (`hanzo.yaml`) plus per-service specs, shared schemas, and everything needed to generate ..."
---
...
|---------|------|----------|
| Cloud | `cloud/openapi.yaml` (116KB) | `api.hanzo.ai` |
...
| GitHub Org | Focus |
|------------|-------|
| @hanzoai | Core platform (all 69 services) |
...
| @hanzoo11y | Observability (loki, grafana, o11y) |
