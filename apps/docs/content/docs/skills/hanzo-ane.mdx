---
title: "Hanzo ANE - Apple Neural Engine Training"
description: "Hanzo ANE trains neural networks directly on the Apple Neural Engine across all Apple Silicon (M1+) — a reverse-engineered private API giving gradient computation and weight updates on the neural engine, not just inference."
---
...
`hanzoai/ANE`. Objective-C and Python, built with `make`.
