...
description: "Hanzo Functions is a Kubernetes-native serverless platform for event-driven workloads with GPU support. Go codebase (module `github.com/fission/fission`, Fission fork), runs as a set of K8s control..."
---
...
Functions are a command group of the Hanzo CLI — `hanzo functions list`,
`hanzo functions invoke`, and the rest. Install the CLI and you have them:
