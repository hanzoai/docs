---
title: "Hanzo Suite"
description: "Hanzo Business Suite is the open-source ERP/CRM behind team.hanzo.ai — CRM, e-commerce, warehouse, projects, accounting, POS, HR, marketing and manufacturing across 584 addons, on Python and PostgreSQL, integrated with Hanzo AI infrastructure."
---

## Overview

Hanzo Business Suite is a **full-featured open-source ERP/CRM platform** integrated with Hanzo AI infrastructure. It covers CRM, e-commerce, warehouse management, project management, billing and accounting, POS, HR, marketing and manufacturing across 584 bundled addons — the whole back office in one application rather than six integrations. Runs as a Python web application backed by PostgreSQL. Live at `team.hanzo.ai` and `hanzo.team`.
