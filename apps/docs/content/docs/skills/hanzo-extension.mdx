---
title: "Hanzo Extensions - Browser & IDE Plugins"
description: "Hanzo Extensions is a monorepo of browser and IDE extensions providing AI-powered development and browsing tools."
---
...
```
1. Extension opens tab → hanzo.id/oauth/authorize?response_type=token&...
...
```typescript
// /oauth/userinfo only returns `sub` — use /api/get-account for full profile
