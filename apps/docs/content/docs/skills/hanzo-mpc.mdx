---
title: "Hanzo MPC"
description: "Hanzo MPC is a threshold signing service that generates and manages wallets across distributed nodes without ever assembling the private key — ECDSA via CGGMP21 and EdDSA via FROST, covering Bitcoin, Ethereum, Lux, XRPL, Solana, TON and all EVM chains."
---
...
cd deploy
docker-compose up -d
# Starts: 3 MPC nodes, NATS, Consul, KMS
```
...
| nats | 4222 (client), 8222 (monitor) | Message broker (JetStream) |
