---
title: "Hanzo Improvement Proposals (HIPs)"
description: "Hanzo Improvement Proposals (HIPs)"
---
...
- **Status**: Draft
- **Category**: Infrastructure
- Self-hosted payment infrastructure built to PCI DSS v4.0 controls, with three-zone isolation
