---
title: "Hanzo CLI - Polyglot Command-Line Interface"
description: "Hanzo CLI is a Rust binary with polyglot SDK proxying — a single CLI that provides unified access to all Hanzo services while automatically proxying commands through Python, Go, and TypeScript SDKs..."
---
