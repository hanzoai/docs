...
description: "Hanzo KMS is a centralized secret management platform for the Hanzo ecosystem. Fork of Hanzo KMS with Hanzo branding, Universal Auth, and K8s-native secret sync via KMSSecret CRD. Live at `kms.hanz..."
---

## Overview

Hanzo KMS is a **centralized secret management platform** for the Hanzo ecosystem. Fork of Hanzo KMS with Hanzo branding, Universal Auth, and K8s-native secret sync via KMSSecret CRD. Live at `kms.hanzo.ai`.
...
Fork of **Hanzo KMS** with 9 ported Vault subsystems. Backend is TypeScript/Node.js. Repo: `hanzoai/kms`.
