---
title: "Hanzo Desktop - AI-Powered Productivity & Mining App"
description: "Hanzo Desktop is an AI-powered command palette and local AI assistant for macOS that merges powerful app launcher capabilities with advanced local AI features."
---
