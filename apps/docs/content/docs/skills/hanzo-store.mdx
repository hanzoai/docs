---
title: "Hanzo Store"
description: "Hanzo Store is a flatfile-based marketplace for discovering and installing AI agent tools and MCP servers. Built with Next.js 15 and static site generation, it serves as the app store for Hanzo Des..."
---
