...
description: "Hanzo Insights is a full product analytics platform — product analytics, feature flags, session recording, A/B testing, heatmaps, LLM analytics, error tracking, surveys and its own query language (InsightsQL), on ClickHouse and PostgreSQL."
---
...
insights/
  insights/           # Django app (Python backend)
    ...
    clickhouse/       # Datastore query builders
    session_recordings/
    heatmaps/
    batch_exports/
