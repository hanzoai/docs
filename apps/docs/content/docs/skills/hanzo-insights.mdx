...
description: "Hanzo Insights is a full product analytics platform — fork of PostHog with feature flags, session recording, A/B testing, InsightsQL, and ClickHouse-powered analytics."
---
