...
description: "Hanzo Insights is a full product analytics platform -- a PostHog fork with product analytics, feature flags, session recording, A/B testing, heatmaps, LLM analytics, error tracking, surveys, web an..."
---
