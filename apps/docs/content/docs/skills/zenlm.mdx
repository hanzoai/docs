...
description: "ZenLM is a collaboration between Hanzo AI and Zoo Labs Foundation, building AI models that run entirely on your device—no cloud, no subscriptions, no surveillance."
---
...
ZenLM is [Zoo Labs Foundation's](https://zoo.industries) (501(c)(3)), focused on sustainable and accessible AI research. Hanzo serves the models.
