...
description: "Hanzo Bot (`@hanzo/bot`) is a TypeScript ESM multi-channel AI messaging gateway that connects AI agents to messaging platforms through a plugin/extension architecture. It provides first-class integ..."
---
