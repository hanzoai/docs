...
description: "Hanzo Treasury is a programmable financial infrastructure stack providing a double-entry ledger, payment connectors, virtual wallets, reconciliation, and workflow orchestration. Go monorepo (forked..."
---
...
3. **SQL** for ledger and payment data storage
...
- `hanzo/hanzo-sql.md` - SQL backend
