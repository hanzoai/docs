---
title: "Hanzo Editor"
description: "Hanzo Editor (`hanzoai/code`) is an open-source AI-native code editor -- a VS Code fork (originally \"Void Editor\") with LLM chat, autocomplete, inline diffs, and agent tool use built directly into ..."
---
