---
title: "Hanzo PubSub Go SDK"
description: "Go client library for Hanzo PubSub, NATS wire compatible. Module `github.com/hanzoai/pubsub-go`. Publish/subscribe, request/reply, JetStream persistence, key-value and object stores, and a microservice framework."
---

## Overview

Go client library for Hanzo PubSub, speaking the NATS wire protocol. Module path `github.com/hanzoai/pubsub-go`. Provides publish/subscribe messaging, request/reply, JetStream persistence, key-value store, object store, and a microservice framework.

### OSS Base

Repo: `hanzoai/pubsub-go`, branch: `main`. Module `github.com/hanzoai/pubsub-go`.
