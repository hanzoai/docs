...
description: "Hanzo Operative enables AI agents to control computers via X11 desktop automation — taking screenshots, moving the mouse, clicking, typing, and executing complex desktop workflows."
---
