---
title: "Hanzo Guard - LLM I/O Safety Layer"
description: "Hanzo Guard is a Rust-based LLM I/O sanitization library and toolkit that sits between applications and LLM providers. Detects and redacts PII, blocks prompt injection attacks, enforces rate limits..."
---
...
- **Compliance**: GDPR, HIPAA and SOC 2 Type II controls; certification scoped per engagement -- audit logs with privacy-preserving hashes
...
- `hanzo/hanzo-ai-api.md` - the Hanzo AI API (Guard sits in front of this)
