---
title: "Hanzo Datastore - Vector Database Integration"
description: "Hanzo Datastore provides a unified vector database abstraction for AI applications — embedding storage, similarity search, and RAG retrieval."
---
