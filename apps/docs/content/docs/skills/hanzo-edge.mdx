---
title: "Hanzo Edge - On-Device AI Inference Runtime"
description: "Hanzo Edge is an on-device AI inference runtime for running Zen models and any GGUF model locally on macOS, Linux, Web (WASM), and embedded devices. Zero cloud dependency, full data privacy, zero n..."
---
...
- `hanzo/hanzo-ai-api.md` - the hosted Hanzo AI API
