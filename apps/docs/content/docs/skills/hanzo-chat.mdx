---
title: "Hanzo Chat - AI Chat Application"
description: "Hanzo Chat (`@hanzochat/chat`) is a full-featured AI chat application — web UI for conversations, agents, RAG pipelines and MCP tools, talking to the Hanzo LLM Gateway for model access. Live at chat.hanzo.ai."
---

## Overview

Hanzo Chat (`@hanzochat/chat`) is a **full-featured AI chat application** -- a web UI for conversing with AI models, managing conversations, running agents, and integrating with RAG pipelines and MCP tools. It connects to the Hanzo AI API (`api.hanzo.ai/v1`) as its backend for model access.
...
- DocumentDB for conversation storage, MeiliSearch for search
...
- `hanzo/hanzo-ai-api.md` -- the Hanzo AI API that Chat connects to
