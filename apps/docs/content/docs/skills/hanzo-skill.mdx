---
title: "Hanzo Skill"
description: "Hanzo Skill (`@hanzo/skill`) is a TypeScript CLI tool for installing, managing, and distributing AI agent skills. It clones skill repositories to `~/.hanzo/skills/` as the canonical source of truth..."
---
