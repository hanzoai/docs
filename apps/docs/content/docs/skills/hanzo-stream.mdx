---
title: "Hanzo Stream"
description: "Hanzo Stream is a stateless Kafka wire protocol gateway that translates standard Kafka client requests into NATS JetStream operations against Hanzo PubSub. Go codebase (module `github.com/hanzoai/s..."
---
...
- `hanzo/hanzo-kv.md` - KV (sibling infrastructure service)
