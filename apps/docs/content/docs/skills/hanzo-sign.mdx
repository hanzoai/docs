---
title: "Hanzo Sign - Open Source Document Signing"
description: "Hanzo Sign is an open-source electronic document signing platform — React Router and Hono frontend, tRPC and ts-rest APIs, Prisma ORM, and PDF signing via P12 certificates or Google Cloud KMS. Live at sign.hanzo.ai. AGPL-3.0."
---
...
- `database` -- Store files as Base64 in SQL (default)
- `s3` -- S3-compatible storage (Hanzo S3, AWS S3, or any S3 endpoint)
...
| `NEXT_PRIVATE_DATABASE_URL` | SQL connection | Connection string |
