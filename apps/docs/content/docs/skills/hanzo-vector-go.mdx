...
description: "Go client library for Hanzo Vector, speaking the Qdrant gRPC protocol. The main package is `qdrant` — types, client and helpers all live there."
---
...
`hanzoai/vector-go`, branch: `master`.
