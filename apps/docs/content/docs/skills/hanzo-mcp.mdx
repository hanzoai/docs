---
title: "Hanzo MCP - Agentic Development with Model Context Protocol"
description: "Hanzo MCP is the agentic workflow layer of the Hanzo ecosystem. It implements the Model Context Protocol — a standard for exposing tools, resources, and prompts to AI agents. Ships 13 HIP-0300 unif..."
---
