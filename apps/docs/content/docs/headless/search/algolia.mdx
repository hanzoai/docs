...
description: Integrate Algolia Search with Hanzo Docs
---
...
import type { DocumentRecord } from '@hanzo/docs-core/search/algolia';
...
import { sync, DocumentRecord } from '@hanzo/docs-core/search/algolia';
...
- Using [Hanzo Docs UI search dialog](/docs/search/algolia).
...
- **Hanzo Docs UI**: Enable [Tag Filter](/docs/search/algolia#tag-filter) on Search UI.
