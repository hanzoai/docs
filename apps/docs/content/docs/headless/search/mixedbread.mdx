---
title: Mixedbread
description: Integrate Mixedbread Search with Hanzo Docs
---
...
import { createMixedbreadSearchAPI } from '@hanzo/docs-core/search/mixedbread';
...
- **Hanzo Docs UI**: see [Search UI](/docs/search/mixedbread) for details.
- **Search Client**:
...
- **Hanzo Docs UI**: Enable [Tag Filter](/docs/search/mixedbread#tag-filter) on Search UI.
