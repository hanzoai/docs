...
description: Integrate Typesense Search with Hanzo Docs
---
...
import { findPath } from '@hanzo/docs-core/page-tree';
...
- Use [Hanzo Docs UI search dialog](/docs/search/typesense).
...
- **Hanzo Docs UI**: Enable [Tag Filter](/docs/search/typesense#tag-filter) on Search UI.
