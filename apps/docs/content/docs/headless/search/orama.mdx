...
<auto-type-table type='Extract<import("@hanzo/docs-core/search/client").Client, { type: "fetch" }>' />
...
- **Search Client**: use `static` instead of `fetch`.
  ...
  <auto-type-table type='Extract<import("@hanzo/docs-core/search/client").Client, { type: "static" }>' />
