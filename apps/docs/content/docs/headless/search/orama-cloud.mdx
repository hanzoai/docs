...
3. Create a script to sync search indexes.
   ...
   import { sync, type OramaDocument } from '@hanzo/docs-core/search/orama-cloud';
...
- Using [Hanzo Docs UI search dialog](/docs/search/orama-cloud).
- Custom search UI using the built-in hook of Hanzo Docs:
