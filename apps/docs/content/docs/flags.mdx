---
title: Feature Flags
description: Native feature flags, percentage rollouts, and A/B experiments — a stateless Rust evaluator embedded in Hanzo Cloud with per-project SQLite definitions and Insights-compatible semantics.
---
...
Semantics are stable and fully specified (deterministic rollout hash, property
operators, variants, and payload shapes), so SDKs and integrations port 1:1.
