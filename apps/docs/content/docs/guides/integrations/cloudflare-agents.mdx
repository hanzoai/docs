...
The other documented path is the AI SDK, which `AIChatAgent` and the starter template already use. Everything on the [Vercel AI SDK page](/docs/guides/integrations/vercel-ai-sdk) applies unchanged inside a Cloudflare Agent.
