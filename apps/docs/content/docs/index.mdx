...
<Cards>
  <Card icon={<Shield />} title="Lux Financial" href="/docs/services/lux" description="Regulated multi-jurisdiction trading with MPC wallets, CEX/DEX routing, and compliance automation" />
  <Card icon={<Lock />} title="MPC Wallets" href="/docs/services/lux/wallets" description="Non-custodial threshold signature wallets for customers and institutions" />
  <Card icon={<Globe />} title="Compliance" href="/docs/services/lux/compliance" description="30+ jurisdictions, PEP/EDD, KYT surveillance, offering-type gating" />
</Cards>
