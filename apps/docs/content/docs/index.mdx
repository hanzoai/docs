---
title: Documentation
description: The AI cloud you can run yourself. One open-source binary, 67 capabilities, one API at api.hanzo.ai — the same binary in production and on your own laptop, GPU, or cluster.
---
...
A cloud is usually a hundred services you rent and never really see. Hanzo is
**one open-source binary** that is the whole cloud — 67 capabilities, one address
at `api.hanzo.ai`, one key. The same binary that serves production runs on your
own laptop, GPU, or cluster. [**The network is the cloud.**](/docs/network)
