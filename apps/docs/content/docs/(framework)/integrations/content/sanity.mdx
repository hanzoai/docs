...
Hanzo Docs provide an official integration to simplify setup for Sanity CMS, it brings native live preview experience without compromise on performance.

> You can see our [Sanity Example](https://github.com/fuma-nama/@hanzo/docs-sanity) on GitHub.
...
```npm
npx @hanzo/docs-cli add hanzo/sanity/base
```

> Or you can run `npx @hanzo/docs-cli add` and browse additional Sanity presets to install.
...
```tsx
import { getSource } from '@/lib/source';
import { renderToc } from '@hanzo/docs-sanity/client';
import { CustomPortableText } from '@/components/sanity';
import { DocsPage, DocsBody, DocsDescription, DocsTitle } from '@hanzo/docs-ui/layouts/docs/page';
