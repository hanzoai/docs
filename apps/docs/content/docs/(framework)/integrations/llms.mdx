---
title: AI & LLMs
description: Integrate AI functionality to Hanzo Docs.
---
...
```npm
npx @hanzo/docs-cli add ai/page-actions
```
...
You can install the AI chat dialog using Hanzo Docs CLI.

<Tabs items={['AI SDK', 'LLMGateway', 'Inkeep AI']}>
<Tab>

```npm
npx @hanzo/docs-cli add ai/openrouter
```
...
> Hanzo Docs doesn't provide the AI model, it's up to you.
>
...
```npm
npx @hanzo/docs-cli add ai/llmgateway
```
...
```npm
npx @hanzo/docs-cli add ai/inkeep
```
