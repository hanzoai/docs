...
> This guide is mainly for **Hanzo Docs MDX**, see the docs of `next-validate-link` for other setups.
...
To access the `source` object outside of app runtime, configure [Hanzo Docs MDX Loader](/docs/mdx/loader/bun) for Bun.
...
You might need to configure TypeScript transpiling (or newer version of Node.js), and [Hanzo Docs MDX Loader](/docs/mdx/loader/node).
