...
Hanzo Docs is a **documentation framework**, designed to be fast, flexible,
...
<Card icon={<PanelsTopLeftIcon className="text-blue-300" />} title='Hanzo Docs UI'  href='/docs/ui'>
...
<Card icon={<TerminalIcon />} title='Hanzo Docs CLI' href='/docs/cli'>
...
A new Hanzo Docs app should be initialized, with following features configured by default:
