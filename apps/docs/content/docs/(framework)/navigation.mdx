...
**Hanzo Docs UI** provides different layouts to display content, you can specify navigation configurations via layouts.
...
You can implement multi-version in your docs in your preferred way, using the primitives provided by Hanzo Docs.
...
Sometimes you want to version the entire website, such as https://v14.fumadocs.dev (Hanzo Docs v14) and https://fumadocs.dev (Latest Hanzo Docs).
