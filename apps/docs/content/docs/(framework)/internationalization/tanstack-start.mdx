...
description: Support i18n routing on your Tanstack Start + Hanzo Docs app.
---
...
Hanzo Docs only handles navigation for its own layouts (e.g. sidebar).
...
In addition, the [`@hanzo/docs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
