---
title: Next.js
description: Support i18n routing on your Next.js + Hanzo Docs app
---
...
In addition, the [`@hanzo/docs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to prepend the locale prefix.
