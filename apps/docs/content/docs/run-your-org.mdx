...
- A [team workspace](/docs/services/team) for collaboration
...
[Hanzo Team](/docs/services/team) gives your org a shared workspace: docs, tasks, calls, meetings, files. It uses the same IAM identity so your existing org members sign in with one click.
