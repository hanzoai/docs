...
<Cards>
  <Card title="Fleet Overview" icon="LayoutDashboard" href="/docs/services/platform/clusters/fleet">
    Monitor all clusters at a glance
  </Card>
  <Card title="Register a Cluster" icon="Plus" href="/docs/services/platform/clusters/register">
    Add an existing cluster
  </Card>
  <Card title="Auto-Provisioning" icon="Wand" href="/docs/services/platform/clusters/provisioning">
    Create new managed clusters
  </Card>
  <Card title="Node Pools" icon="Layers" href="/docs/services/platform/clusters/node-pools">
