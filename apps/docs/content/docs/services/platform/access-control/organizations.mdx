...
Organizations can also be managed via the API. See [Organizations API](/docs/services/platform/api/organizations).

```bash
# List your organizations
curl https://app.platform.hanzo.ai/v1/organization.all \
