...
- **Skills Library** -- Community-contributed skill packages covering code generation, data analysis, web scraping, DevOps, design, writing, research, and more.
...
- **Multi-Model Support** -- Route conversations to any LLM provider via the Hanzo LLM Gateway (Claude, GPT, Qwen3, Gemini, Llama, and more).
...
Skills span categories including:
