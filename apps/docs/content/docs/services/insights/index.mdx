...
> **API reference** · [Insights →](/docs/openapi/insights) — every endpoint, generated from the OpenAPI spec.

Hanzo Insights is a self-hosted behavioral analytics platform running at `insights.hanzo.ai`. It provides product analytics, feature flags, session recording, A/B testing, and cohort analysis — all with complete data ownership.
