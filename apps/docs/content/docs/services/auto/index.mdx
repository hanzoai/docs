---
title: Hanzo Auto
description: AI-powered workflow automation platform with hundreds of integrations
---

# Hanzo Auto

Hanzo Auto is an enterprise workflow automation platform (based on ActivePieces) that connects hundreds of services through a visual flow builder. Build automated workflows with AI-native actions, triggers, and integrations — all multi-tenant and SSO-enabled via Hanzo IAM.

## Features

- **Integrations**: Slack, GitHub, Google Sheets, Salesforce, HubSpot, and hundreds more
...
5. Chain actions from all available integrations
...
- [Bot Hub Integrations](https://hub.hanzo.bot/api/v1/integrations) — All integrations cataloged
- [@hanzo/mq](https://github.com/hanzoai/mq) — Message queue (BullMQ fork)
- [@hanzo/kv-client](https://github.com/hanzoai/kv-client) — KV client (iovalkey fork)
- [ActivePieces Docs](https://www.activepieces.com/docs) — Upstream documentation
