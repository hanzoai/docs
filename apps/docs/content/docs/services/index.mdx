---
title: Platform
description: Hanzo Cloud Platform — 33 unified services for AI, automation, infrastructure, and operations.
index: true
icon: Cloud
---
...
<Cards>
  ...
  <Card title="Hanzo Stream" href="/docs/services/stream">
  ...
  <Card title="Hanzo Registry" href="/docs/services/registry">
    Container and artifact registry for Docker images
  </Card>
  <Card title="Hanzo Visor" href="/docs/services/visor">
...
<Cards>
  ...
  <Card title="Hanzo DNS" href="/docs/services/dns">
