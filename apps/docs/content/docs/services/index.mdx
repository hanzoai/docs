---
title: Services
description: Hanzo Cloud services -- AI, automation, platform, infrastructure, and operations.
index: true
icon: Cloud
---
...
The decentralized AI cloud. Everything at `api.hanzo.ai`.

## AI & Intelligence

<Cards>
  <Card title="Cloud" href="/docs/services/cloud">
    Unified LLM inference gateway across all major providers
  </Card>
  ...
  <Card title="Bot" href="/docs/services/bot">
    Multi-channel AI assistant with skills engine and plugin SDK
  </Card>
...
<Cards>
  ...
  <Card title="DID" href="/docs/services/did">
    Decentralized identity, profiles, and directory services
  </Card>
