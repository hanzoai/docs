...
Besides the enforce API, Hanzo IAM exposes APIs to read policy data; they are listed below.

### Enforce

POST to `/v1/iam/enforce` with **exactly one** of these query parameters:
...
```shell
curl --location --request POST 'http://localhost:8000/v1/iam/enforce?permissionId=example-org/example-permission' \
...
```shell
curl --location --request POST 'http://localhost:8000/v1/iam/enforce?modelId=example-org/example-model' \
--header 'Content-Type: application/json' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>' \
--data-raw '["example-org/example-user", "example-resource", "example-action"]'
...
```shell
curl --location --request POST 'http://localhost:8000/v1/iam/enforce?resourceId=example-org/example-resource' \
--header 'Content-Type: application/json' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>' \
--data-raw '["example-org/example-user", "example-resource", "example-action"]'
...
```shell
curl --location --request POST 'http://localhost:8000/v1/iam/batch-enforce?permissionId=example-org/example-permission' \
--header 'Content-Type: application/json' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>' \
...
```shell
curl --location --request POST 'http://localhost:8000/v1/iam/batch-enforce?modelId=example-org/example-model' \
--header 'Content-Type: application/json' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>' \
...
```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-objects?userId=example-org/example-user' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'

Without `userId` (uses session):

```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-objects' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'
...
```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-actions?userId=example-org/example-user' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'

Without `userId` (uses session):

```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-actions' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'
...
```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-roles?userId=example-org/example-user' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'

Without `userId` (uses session):

```shell
curl --location --request GET 'http://localhost:8000/v1/iam/get-all-roles' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'
...
Runs Casbin CLI commands (Java, Go, Node.js, Python, etc.) via Hanzo IAM and returns the output. Results are cached in memory for 5 minutes; identical requests return the cached result.
...
```shell
curl --location --request GET 'http://localhost:8000/v1/iam/run-casbin-command?language=go&args=["-v"]' \
--header 'Authorization: Basic <Your_Application_ClientId> <Your_Application_ClientSecret>'
