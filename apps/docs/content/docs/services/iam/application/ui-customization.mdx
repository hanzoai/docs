...
<div class="left-model">
  <span class="side-logo"> <img src="/img/iam/hanzo-iam-logo.svg" alt="Hanzo IAM" style="width: 120px"> 
    <span>SSO</span> 
  </span>
  <div class="img">
    <img src="/img/iam/hanzo.svg" alt="Hanzo IAM"/>
  </div>
</div>
...
- [Customize theme](/docs/services/iam/organization/customize-theme) — primary color and border radius
- [Sign-up items table](/docs/services/iam/application/signup-items-table)
- [Application config](/docs/services/iam/application/config)
