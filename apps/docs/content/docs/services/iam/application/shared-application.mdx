...
Example: application client ID `2dc94ccbec09612c04ac`, organization `casbin` → use client ID `2dc94ccbec09612c04ac-org-casbin`. OAuth authorize URL: `https://iam.hanzo.ai/login/oauth/authorize?client_id=2dc94ccbec09612c04ac-org-casbin&response_type=code&redirect_uri=...&scope=read&state=iam`.
