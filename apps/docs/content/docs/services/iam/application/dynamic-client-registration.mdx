...
```json
{
  ...
  "authorization_endpoint": "https://your-iam.com/login/oauth/authorize",
  "token_endpoint": "https://your-iam.com/api/login/oauth/access_token",
  "registration_endpoint": "https://your-iam.com/api/oauth/register",
  ...
}
...
```bash
curl -X POST https://your-iam.com/api/oauth/register \
