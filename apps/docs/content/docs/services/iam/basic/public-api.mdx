...
curl -X GET https://iam.hanzo.ai/api/get-account \
...
On the application edit page (e.g. `https://iam.hanzo.ai/applications/casbin/app-vue-python-example`) you’ll see **Client ID** and **Client Secret**.
