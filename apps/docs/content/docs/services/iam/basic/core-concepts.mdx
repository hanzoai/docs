...
:::tip
The `Properties` field is a key-value map for custom user attributes. See [User overview](/docs/services/iam/user/overview#using-the-properties-field) for usage and best practices.
:::
...
Use `getSignupUrl()` and `getSigninUrl()` from [@hanzo/iam](https://github.com/iam/@hanzo/iam/blob/3d08d726bcd5f62d6444b820596e2d8472f67d97/src/sdk.ts#L50-L63).
...
See **[Providers overview](/docs/services/iam/provider/overview)** for the full list of supported provider types.
