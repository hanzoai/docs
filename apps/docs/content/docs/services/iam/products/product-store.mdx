...
Users access the Product Store through the `/product-store` route in your Hanzo IAM instance. The store displays published products in a responsive grid layout. What you see depends on the product type:
