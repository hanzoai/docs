...
Developers can programmatically delete sessions using the Hanzo IAM API:
...
```bash
POST /v1/iam/delete-session?sessionId={'{'}session-id{'}'}
...
- [Single Sign-Out](/docs/services/iam/session/single-sign-out): Learn about SSO logout functionality
