...
Make sure your application can redirect to the user's profile page. The [getMyProfileUrl(account, returnUrl)](https://github.com/iam/iam-js-sdk#get-my-profile-page-url) API is provided in our SDK for each language.
