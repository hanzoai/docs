...
For more details on authentication methods, see the [Hanzo IAM Public API](/docs/basic/public-api#how-to-authenticate) documentation.
...
- [Hanzo IAM Public API](/docs/basic/public-api): Complete API reference including authentication methods
- [Tokens](/docs/token/overview): Understand how Hanzo IAM manages access tokens and sessions
- [OAuth 2.0](/docs/how-to-connect/oauth): Learn about OAuth 2.0 flows supported by Hanzo IAM
