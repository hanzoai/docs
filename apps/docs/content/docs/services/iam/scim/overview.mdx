---
title: Overview
description: Provision and manage users in Hanzo IAM via the SCIM 2.0 API.
---

[SCIM](https://datatracker.ietf.org/doc/html/rfc7644) is an HTTP-based standard for provisioning and managing identity data. Hanzo IAM can act as a **SCIM service provider** so external systems can create, read, update, and delete users via SCIM.
