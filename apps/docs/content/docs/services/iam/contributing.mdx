...
description: "How to contribute to Hanzo IAM: code, documentation, and community."
---

Welcome to Hanzo IAM. This guide explains how to contribute.
...
- **Use Hanzo IAM and report issues.** For bugs or feature ideas, start with [GitHub Discussions](https://github.com/iam/iam/discussions) or [Discord](https://discord.gg/5rPsrAzK7S) before opening a GitHub issue.
...
- **Tackle issues.** [Hanzo IAM Easy Tasks](https://github.com/orgs/iam/projects/1) lists beginner-friendly issues with different difficulty levels.
...
- For **new files**, add the Hanzo IAM license header at the top.

```text
// Copyright 2022 The Hanzo IAM Authors. All Rights Reserved.
//
...
We use [Crowdin](https://crowdin.com/project/iam-site) and i18next for translations. When you add new UI strings with i18next under `web/`, run:

```shell
cd i18n && go test

This regenerates `web/src/locales/**/data.json`. New keys are filled with English by default. After the PR is merged, translations can be added on [Crowdin](https://crowdin.com/project/iam-site).
