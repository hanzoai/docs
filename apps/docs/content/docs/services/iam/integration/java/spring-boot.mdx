...
Deploy Hanzo IAM in **production mode**. See [Server installation](/docs/services/iam/basic/server-installation). Ensure the server is reachable and you can sign in (e.g. `admin` / `123`).
