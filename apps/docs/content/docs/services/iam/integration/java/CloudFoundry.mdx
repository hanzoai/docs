---
title: Cloud Foundry
description: Learn how to integrate Hanzo IAM with Cloud Foundry to secure your applications.
---

Deploy Hanzo IAM first (see [Server installation](/docs/services/iam/basic/server-installation)). Then configure the application and Cloud Foundry as below.
...
2. Add a redirect URL: `http://IAM_HOSTNAME/login`
   ![Hanzo IAM Application Setting](/img/integration/java/CloudFoundry/cas.png)
...
* $ cd uaa
* $ ./gradlew run
  ![Hanzo IAM Application Setting](/img/integration/java/CloudFoundry/command.png)
...
![Hanzo IAM Application Setting](/img/integration/java/CloudFoundry/parameter.png)

Execute the command, and we can get the result below, which means that we have successfully integrated Hanzo IAM with Cloud Foundry.
![Hanzo IAM Application Setting](/img/integration/java/CloudFoundry/result.png)

![Hanzo IAM Application Setting](/img/integration/java/CloudFoundry/login.gif)
