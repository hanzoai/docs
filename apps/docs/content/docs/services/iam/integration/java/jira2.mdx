...
[Hanzo IAM](/docs/services/iam/basic/server-installation) can use the OIDC protocol as an IDP to connect various applications. Here is a [Jira](https://www.atlassian.com/software/jira/guides/getting-started/overview) tutorial.
