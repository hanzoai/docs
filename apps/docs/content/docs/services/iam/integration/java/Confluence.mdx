...
[Hanzo IAM](/docs/services/iam/basic/server-installation) can use OIDC protocol as an IDP to connect various applications. In this guide, we will use [Confluence](https://www.atlassian.com/software/confluence) as an example to demonstrate how to use OIDC to connect your applications.
...
First, deploy [Hanzo IAM](/docs/services/iam/basic/server-installation) and [Confluence](https://www.atlassian.com/software/confluence).
