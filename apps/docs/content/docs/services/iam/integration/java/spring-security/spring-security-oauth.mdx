...
Deploy Hanzo IAM. See [Server installation](/docs/basic/server-installation). Ensure the server is running and you can open the login page and sign in (e.g. `admin` / `123`).
...
2. Add your redirect URL (You can find more details on how to obtain the redirect URL in the next section).
   ![Hanzo IAM Application Settings](/img/integration/appsetting_spring_security.png)
  ...
  security:
    oauth2:
      client:
        ...
        provider:
          iam:
            authorization-uri: http://IAM_HOSTNAME:7001/login/oauth/authorize
            token-uri: http://IAM_HOSTNAME:8000/api/login/oauth/access_token
...
spring.security.oauth2.client.provider.iam.authorization-uri=http://IAM_HOSTNAME:7001/login/oauth/authorize
spring.security.oauth2.client.provider.iam.token-uri=http://IAM_HOSTNAME:8000/api/login/oauth/access_token
...
If you visit your root page, you will see the Hanzo IAM Application Setting.
![Hanzo IAM Application Setting](/img/integration/java/spring-security/spring_security_welcome.png)

Click the `login` button and the page will redirect you to Hanzo IAM's login page.
![Hanzo IAM Application Setting](/img/integration/java/spring-security/spring_security_iam.png)

After logging in, the page will redirect you to `/foos`.
![Hanzo IAM Application Setting](/img/integration/java/spring-security/spring_security_resource.png)
