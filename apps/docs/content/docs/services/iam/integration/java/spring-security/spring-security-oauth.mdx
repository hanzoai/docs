...
Deploy Hanzo IAM. See [Server installation](/docs/services/iam/basic/server-installation). Ensure the server is running and you can open the login page and sign in (e.g. `admin` / `123`).
      ...
      client:
        ...
        provider:
          iam:
            ...
            user-info-uri: http://IAM_HOSTNAME:8000/v1/iam/get-account
...
spring.security.oauth2.client.provider.iam.user-info-uri=http://IAM_HOSTNAME:8000/v1/iam/get-account
