...
Configure an organization and an application in Hanzo IAM (see [Application](/docs/services/iam/application/config) and [Organization](/docs/services/iam/organization/overview)).
