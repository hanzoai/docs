---
title: Zentao
description: Using Hanzo IAM for authentication in Zentao
---

[Zentao](https://www.zentao.pm/) is an agile project management tool. It does not support OIDC natively; use the [zentao-oidc](https://github.com/iam/zentao-oidc) module to integrate Hanzo IAM SSO.

## Step 1: Deploy Hanzo IAM and Zentao

Deploy [Hanzo IAM](/docs/services/iam/basic/server-installation) and [Zentao](https://www.zentao.pm/download/zentao-community-edition-release-164-1100.html). Ensure both are running and you can sign in to each.

## Step 2: Integrate Zentao OIDC third-party module

Install [zentao-oidc](https://github.com/iam/zentao-oidc) by running the following command:
...
4. If you don't want the Zentao login screen to appear, go directly to the Hanzo IAM login screen.
...
2. Add your redirect URL.
   ![Hanzo IAM Application Setting](/img/integration/php/zentao/clientId.png)
