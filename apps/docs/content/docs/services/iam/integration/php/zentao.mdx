...
Deploy [Hanzo IAM](/docs/basic/server-installation) and [Zentao](https://www.zentao.pm/download/zentao-community-edition-release-164-1100.html). Ensure both are running and you can sign in to each.
