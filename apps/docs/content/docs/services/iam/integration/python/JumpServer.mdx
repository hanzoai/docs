...
[Hanzo IAM](/docs/services/iam/basic/server-installation) can be used to connect [JumpServer](https://github.com/jumpserver/jumpserver/).
...
Deploy [Hanzo IAM](/docs/services/iam/basic/server-installation) and [JumpServer](https://github.com/jumpserver/jumpserver/).

After successful deployment, ensure the following:

1. Hanzo IAM can be logged in and used normally.
2. For local `prod` mode, set IAM_HOSTNAME to `http://localhost:8000`. See [production mode](/docs/services/iam/basic/server-installation#production-mode).
...
See [CAS](/docs/services/iam/how-to-connect/cas).
...
See [CAS](/docs/services/iam/how-to-connect/cas) and [JumpServer CAS](https://docs.jumpserver.org/zh/master/admin-guide/authentication/cas/).
