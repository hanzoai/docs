...
This guide configures [Bytebase](https://www.bytebase.com/docs/get-started/self-host/) to sign in via [Hanzo IAM](/docs/services/iam/basic/server-installation) using OAuth2/OIDC.
...
Deploy [Hanzo IAM](/docs/services/iam/basic/server-installation) and [Bytebase](https://www.bytebase.com/docs/get-started/self-host/). Ensure both are running and you can sign in to Hanzo IAM. For production, see [production mode](/docs/services/iam/basic/server-installation#production-mode).
