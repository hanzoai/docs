---
title: Gitea
description: Use Hanzo IAM as the OAuth/OIDC provider for Gitea sign-in.
---

[Gitea](https://gitea.io/en-us/) supports OAuth2/OIDC for sign-in. This guide configures Hanzo IAM as the identity provider.
...
### 1. Create a Hanzo IAM application
...
![Create an Hanzo IAM application](/img/integration/go/gitea/gitea6.png)
...
### 3. Set the callback URL in Hanzo IAM
