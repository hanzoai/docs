---
title: Overview
description: "Use Hanzo IAM for subscription and pricing: plans, payments, and subscriptions."
---

Hanzo IAM can act as a subscription and pricing system using **Product**, **Payment**, **Plan**, **Pricing**, **Subscription**, and **Transaction**. You define which plans appear in each price list:
