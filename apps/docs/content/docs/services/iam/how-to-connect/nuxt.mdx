...
The [nuxt-auth](https://github.com/iam/nuxt-auth) repo demonstrates Hanzo IAM integration in Nuxt. The flow is similar to the [Next.js](/docs/services/iam/how-to-connect/nextjs) example.

## Step 1: Deploy Hanzo IAM

Deploy Hanzo IAM in [production mode](/docs/services/iam/basic/server-installation). Confirm the login page works (e.g. at `http://localhost:8000` with `admin` / `123` in dev).
...
See [How to use Hanzo IAM SDK](/docs/services/iam/how-to-connect/sdk).
