...
:::warning
For JavaScript and TypeScript, the one canonical SDK is [`@hanzo/iam`](https://www.npmjs.com/package/@hanzo/iam). Use it for all server validation, better-auth, NextAuth, React SPA, and Passport integrations against the canonical `/v1/iam/oauth/*` endpoints — see the [Authentication guide](/docs/authentication). The per-language packages below are the upstream reference for non-JS backends.
:::
...
|------------------|------------------------|---------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Electron SDK     | For Electron apps      | [@hanzo/iam](https://github.com/iam/@hanzo/iam)         | [iam-electron-example](https://github.com/iam/iam-electron-example)                                                                                                                                                                                                                                                                            |
...
|-------------------|----------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Javascript SDK    | For traditional non-SPA websites | [@hanzo/iam](https://github.com/iam/@hanzo/iam)       | Nodejs backend: [iam-raw-js-example](https://github.com/iam/iam-raw-js-example)<br />Go backend: [iam-go-react-sdk-example](https://github.com/iam/iam-go-react-sdk-example)                                 |
| Frontend-only SDK | For frontend-only SPA websites   | [@hanzo/iam](https://github.com/iam/@hanzo/iam)       | [iam-react-only-example](https://github.com/iam/iam-react-only-example)                                                                                                                                                  |
...
First, install `@hanzo/iam` via NPM or Yarn:
...
Show "Sign up" and "Sign in" buttons or links to users; URLs can be obtained from the frontend or backend. See [Login URLs](/docs/services/iam/basic/core-concepts#login-urls).
...
1. `User`: the User object, containing all information for the logged-in user, see definition
   at: **[/docs/services/iam/basic/core-concepts#user](/docs/services/iam/basic/core-concepts#user)**
...
These functions are implemented by making RESTful calls against `Hanzo IAM Public API`. If a function is not in the Hanzo IAM Backend SDK, call the [Public API](/docs/services/iam/basic/public-api) directly.
