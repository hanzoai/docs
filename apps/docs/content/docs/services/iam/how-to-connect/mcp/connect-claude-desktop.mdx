...
description: Connect Claude Desktop to Hanzo IAM’s MCP server with OAuth.
---
...
- Explore available [MCP Tools](/docs/services/iam/how-to-connect/mcp/tools) that Claude can use
