...
2. **Check WWW-Authenticate header** on unauthorized requests:
   ...
   WWW-Authenticate: Bearer realm="mcp-server",
     authorization_uri="https://your-iam.com/login/oauth/authorize",
...
```bash
curl -X POST https://your-iam.com/api/login/oauth/introspect \
...
# Open in browser:
https://your-iam.com/login/oauth/authorize?
