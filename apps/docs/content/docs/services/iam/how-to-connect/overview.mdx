...
**[Standard OIDC client](/docs/services/iam/how-to-connect/oidc-client)** — Use any standard OIDC client library available for your language or framework.
...
**[Hanzo IAM SDKs](/docs/services/iam/how-to-connect/sdk)** — Hanzo IAM provides SDKs for many languages, built on OIDC and adding Hanzo IAM-specific features (e.g. user management, file upload).
...
**[Hanzo IAM plugin](/docs/services/iam/how-to-connect/plugin)** — If your app runs on a supported platform (e.g. Spring Boot, WordPress), use the official or community plugin or middleware. Plugins are the fastest way to add Hanzo IAM to that platform.

**Plugins:**

- [Jenkins plugin](/docs/services/iam/integration/java/jenkins-plugin)
- [APISIX plugin](/docs/services/iam/integration/lua/apisix#connect-hanzo-iam-via-apisixs-hanzo-iam-plugin)
...
Hanzo IAM can act as a **SAML 2.0 IdP** and supports the main SAML 2.0 features. See **[SAML](/docs/services/iam/how-to-connect/saml/overview)** for details.

**Example:** [Hanzo IAM as a SAML IdP in Keycloak](/docs/services/iam/how-to-connect/saml/keycloak#add-the-saml-idp-in-keycloak)
...
Hanzo IAM supports **CAS 1.0, 2.0, and 3.0**. See **[CAS](/docs/services/iam/how-to-connect/cas)** for setup.
