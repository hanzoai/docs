...
```json
{
  ...
  "authorization_endpoint": "https://iam.hanzo.ai/login/oauth/authorize",
  "token_endpoint": "https://iam.hanzo.ai/api/login/oauth/access_token",
  "userinfo_endpoint": "https://iam.hanzo.ai/api/userinfo",
  "jwks_uri": "https://iam.hanzo.ai/.well-known/jwks",
  "introspection_endpoint": "https://iam.hanzo.ai/api/login/oauth/introspect",
