---
title: Hanzo IAM authenticator app
description: TOTP authenticator app for iOS and Android, synced with Hanzo IAM.
---

**Hanzo IAM Authenticator** ([app.hanzo.ai](https://app.hanzo.ai/)) is an open-source TOTP app ([GitHub](https://github.com/iam/iam-authenticator)) similar to Google Authenticator or Microsoft Authenticator. It provides MFA with time-based one-time passwords (TOTP) on iOS and Android and can sync accounts with Hanzo IAM.
...
- **Android**: [Releases](https://github.com/iam/iam-authenticator/releases) or [app.hanzo.ai](https://app.hanzo.ai).
- **iOS**: See [app.hanzo.ai](https://app.hanzo.ai) and the [repo](https://github.com/iam/iam-authenticator).
- **Build from source**: [Hanzo IAM Authenticator – Building from source](https://github.com/iam/iam-authenticator#building-from-source).
