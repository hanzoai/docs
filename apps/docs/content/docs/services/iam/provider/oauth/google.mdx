...
:::info
**Authorized redirect URIs** in Google must be **Hanzo IAM’s callback URL**. In Hanzo IAM, the application **Redirect URL** is your application’s callback URL. See [Application config](/docs/services/iam/application/config#how-the-flow-works).
:::
