...
:::info
In the GitHub App, **Callback URL** must be **Hanzo IAM’s callback URL**. In Hanzo IAM, the application **Redirect URL** is your app’s callback URL. See [Application config](/docs/services/iam/application/config#how-the-flow-works).
:::
