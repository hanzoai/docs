...
Add the Polar provider to the product in Hanzo IAM. Users are redirected to Polar for checkout and returned to your app when payment completes or is cancelled.
