...
Add this provider to the product in Hanzo IAM. Set the product’s **name** (or identifier) to the **Variant ID** from the Lemon Squeezy product. Checkout redirects users to Lemon Squeezy.
