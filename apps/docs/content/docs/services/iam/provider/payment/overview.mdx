...
To accept payments in Hanzo IAM, create **Payment** providers and attach them to your [products](/docs/services/iam/products/product). Users can then choose a payment method when purchasing.
