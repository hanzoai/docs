...
description: Use PayPal as a payment provider in Hanzo IAM.
---
...
:::note
The steps above use PayPal **Sandbox**. For production, create an app in **Live** mode and set `runmode=prod` in Hanzo IAM’s `conf/app.conf`.
:::
