...
See [Account customization](/docs/services/iam/organization/accountCustomization) for field configuration.
...
Identity verification is available through the `/v1/iam/verify-identification` endpoint. The API supports:
