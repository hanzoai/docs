---
title: MinIO storage
description: Use MinIO as a Hanzo IAM storage provider.
---

[MinIO](https://github.com/minio/minio) is S3-compatible object storage. Use it as a Hanzo IAM storage provider for file uploads (e.g. avatars).
...
## 2. Add the provider in Hanzo IAM
