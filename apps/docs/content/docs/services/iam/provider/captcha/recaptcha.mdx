...
Hanzo IAM uses **reCAPTCHA v2 Checkbox** from Google. See [reCAPTCHA docs](https://developers.google.com/recaptcha) and [verify API](https://developers.google.com/recaptcha/docs/verify).
