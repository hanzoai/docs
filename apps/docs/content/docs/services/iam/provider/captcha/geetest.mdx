...
![Configure app provider](/img/providers/captcha/geetest_iam_configure.gif)

## 3. Apply to an application

Edit the application in Hanzo IAM, add the Geetest provider to its provider list, and save.
