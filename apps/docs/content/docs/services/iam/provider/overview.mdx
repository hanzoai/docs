...
3. For **OAuth** and **Captcha** providers, further configure how they are used. See [OAuth](/docs/provider/oauth/overview#attaching-the-provider-to-an-application) and [Captcha](/docs/provider/captcha/default#configure-in-iam).
