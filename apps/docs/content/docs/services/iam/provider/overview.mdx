...
| Type | Purpose |
|------|--------|
| **OAuth** | Sign-in via external identity providers (e.g. GitHub, Google, QQ). See [OAuth](/docs/services/iam/provider/oauth/overview). |
...
3. For **OAuth** and **Captcha** providers, further configure how they are used. See [OAuth](/docs/services/iam/provider/oauth/overview#attaching-the-provider-to-an-application) and [Captcha](/docs/services/iam/provider/captcha/default#configure-in-iam).
