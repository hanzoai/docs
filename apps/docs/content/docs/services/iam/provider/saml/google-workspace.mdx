...
- **ACS URL**: `https://<your-iam-domain>/v1/iam/acs`
  - Example: `https://door.example.com/v1/iam/acs`
- **Entity ID**: `https://<your-iam-domain>/v1/iam/acs`
...
The `/v1/iam/acs` endpoint only accepts POST requests. Google Workspace uses POST binding by default.
...
Copy the generated **SP ACS URL** and **SP Entity ID** values (they should match `https://<your-iam-domain>/v1/iam/acs`).
