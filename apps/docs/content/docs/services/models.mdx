...
> **API reference** · [Models →](/docs/openapi/models) — every endpoint, generated from the OpenAPI spec.

The catalogue lives at [**Models**](/docs/models) — every model the gateway
...
This page is the service note: how the model surface behaves once you have
picked an id.
...
<Cards>
  <Card title="Enso" href="https://hanzo.ai/enso">
    What the frontier tier is and when to reach for it — Flash, Pro, Ultra
  </Card>
  <Card title="Zen models" href="https://zenlm.org">
