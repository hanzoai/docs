...
<Cards>
  <Card title="Hanzo Bot" href="/docs/services/bot">
    AI assistant framework for building conversational agents with a skills engine, plugin SDK, and mDNS gateway discovery.
  </Card>
  ...
  <Card title="Hanzo Flow" href="/docs/services/flow">
    Visual workflow builder with community integrations for connecting APIs, databases, and AI models into automation chains.
  </Card>
  <Card title="Hanzo Agent" href="/docs/services/agent">
