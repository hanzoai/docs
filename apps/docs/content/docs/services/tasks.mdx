...
Workers connect to the Tasks server via gRPC, poll for work on task queues, execute activities, and report results back. The server persists all state to SQL.
