...
> **API reference** · [Ingress →](/docs/openapi/ingress) — every endpoint, generated from the OpenAPI spec.
...
<Cards>
  <Card title="Gateway" href="/docs/services/gateway">
    The API gateway in front of Hanzo Cloud -- endpoint routing, rate limiting, telemetry
  </Card>
