---
title: Hanzo Chat
description: AI chat platform with Zen models, third-party models from all major providers, MCP tools, and agents
---

# Hanzo Chat

Hanzo Chat is a production-ready AI chat platform. It ships first-party Zen models alongside third-party models from OpenAI, Anthropic, Google, Meta, and Mistral. Built-in MCP tool support, agents, file uploads, vision, and conversation history make it a complete chat solution for teams and products.

## Features

- **Zen Models**: Flagship, reasoning, code, vision, multimodal, edge, safety, and embeddings
- **Third-Party Models**: OpenAI, Anthropic, Google, Meta, Mistral, Together, Groq, and more
...
|  +----------------------------------------------------------+ |
|  |                  Provider Layer                            | |
|  |  Zen LM . OpenAI . Anthropic . Google . Meta . ...         | |
|  +----------------------------------------------------------+ |
|                                                                |
+---------------------------------------------------------------+
```
...
endpoints:
  hanzo:
    # Zen models + third-party via Hanzo Gateway
...
Models from all major providers are available through the Hanzo Gateway:
...
See [Zen LM Pricing](/docs/api/pricing) for the full pricing table.
...
- [Zen LM Models](/docs/models) -- Full model catalog with specs and pricing
