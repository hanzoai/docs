...
description: SQLite, ZAP binary protocol (PostgreSQL, MongoDB, Redis, Datastore), and custom driver support.
---
...
| **Backends** | SQLite only | PostgreSQL, MongoDB, Redis, Datastore |
