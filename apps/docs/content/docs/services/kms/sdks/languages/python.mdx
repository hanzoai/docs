...
client = Hanzo KMSSDKClient(host="https://app.kms.hanzo.ai")
...
## Hanzo KMSSDKClient Parameters

The `Hanzo KMSSDKClient` takes the following parameters, which are used as a global configuration for the lifetime of the SDK instance.
