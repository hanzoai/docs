...
kms = HanzoKMSSDK::HanzoKMSClient.new('https://app.kms.hanzo.ai')
...
```ruby
kms = HanzoKMSSDK::HanzoKMSClient.new('https://app.kms.hanzo.ai') # Optional parameter, default is https://api.kms.hanzo.ai
```
