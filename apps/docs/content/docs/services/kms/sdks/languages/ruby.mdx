...
kms = HanzoKMSSDK::HanzoKMSClient.new('https://kms.hanzo.ai')
...
This example demonstrates how to use the Hanzo KMS Ruby SDK in a simple Ruby application. The application retrieves a secret named `API_KEY` from the `dev` environment of the `YOUR_PROJECT_ID` project.
...
```ruby
kms = HanzoKMSSDK::HanzoKMSClient.new('https://kms.hanzo.ai') # Optional parameter, default is https://kms.hanzo.ai
```
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        <ParamField query="Site URL" type="string" optional>
            The URL of the Hanzo KMS API. Default is `https://kms.hanzo.ai`.
        </ParamField>
