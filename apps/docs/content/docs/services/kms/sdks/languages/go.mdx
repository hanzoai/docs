...
func main() {
	...
	client := kms.NewHanzoKMSClient(context.Background(), kms.Config{
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        <ParamField query="SiteUrl" type="string" optional default="https://app.kms.hanzo.ai">
...
```go
  ...
  client := kms.NewHanzoKMSClient(ctx, kms.Config{
