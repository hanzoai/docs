---
title: "Hanzo KMS Node.js SDK"
sidebarTitle: "Node.js"
icon: "/images/sdks/languages/node.svg"
---

If you're working with Node.js, the official Hanzo KMS Node.js SDK package is the easiest way to fetch and work with secrets for your application. 
...
- `kmsKeyId` (string): The ID of the KMS key to use for the project. Will use the Hanzo KMS by default.
...
- `position` (number): An optional position of the environment to be created. The position is used in the Hanzo KMS UI to display environments in order. Environments with the lowest position come first.
