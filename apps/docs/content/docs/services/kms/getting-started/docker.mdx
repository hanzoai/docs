...
The [KMS CLI](/cli/overview) can be added to Dockerfiles to fetch secrets from Hanzo KMS and make them available as environment variables within containers at runtime.
