...
Hanzo KMS can be used in two ways: via [Hanzo KMS Cloud](https://app.kms.hanzo.ai), a managed offering, or through a self-hosted deployment within your own infrastructure.
...
Hanzo KMS Cloud is our managed service found at [app.kms.hanzo.ai](https://app.kms.hanzo.ai). It includes automated updates, availability guarantees, and secure infrastructure operations.
...
<Info>
  ...
  <p>Contact sales@hanzo.ai to learn more.</p>
</Info>
