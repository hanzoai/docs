...
>
  Learn what Hanzo KMS is and how it can help you manage secrets, certificates,
...
<Columns cols="2">
  <Card title="CLI Reference" icon="terminal" href="/cli/overview">
    Explore Hanzo KMS’s command-line interface for managing secrets,
  ...
  <Card title="API Reference" icon="book-open-lines" href="/api-reference/overview/introduction">
    Browse Hanzo KMS’s API documentation to programmatically interact with
    secrets, access controls, and certificate workflows.
  </Card>
</Columns>
<Columns cols="2">
  <Card title="Self-Hosting" icon="server" href="/self-hosting/overview">
    Learn how to deploy and operate Hanzo KMS on your own infrastructure with
