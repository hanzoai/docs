---
title: "What is Hanzo KMS?"
sidebarTitle: "What is Hanzo KMS?"
description: "The open source platform for managing secrets, certificates, and secure infrastructure access."
---

## What is Hanzo KMS?

[Hanzo KMS](https://kms.hanzo.ai) is the [open source](https://github.com/hanzoai/kms/kms), all-in-one platform for secrets, certificates, and privileged access management.
...
Start managing secrets securely with [Hanzo KMS Cloud](https://app.kms.hanzo.ai) or learn how to [host Hanzo KMS](/self-hosting/overview) yourself.
...
Hanzo KMS addresses this challenge by providing an all-in-one platform and workflows to:
...
Hanzo KMS is designed to integrate cleanly into your stack—improving security without adding complexity.

## What does Hanzo KMS include?

Hanzo KMS consists of several tightly integrated products, each designed to solve a specific part of the infrastructure security surface:
...
- [Hanzo KMS](/documentation/platform/kms/overview): Encrypt and decrypt data using centrally managed keys with enforced access policies and full audit visibility.
