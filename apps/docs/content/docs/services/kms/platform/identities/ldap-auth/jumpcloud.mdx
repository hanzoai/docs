...
<Steps>
  ...
  <Step title="Configuring LDAP auth for your identity">
    ...
    <Step title="Authenticating with the identity">
      ...
      <Note>
        For EU Cloud and Self-Hosted users, make sure to replace `https://kms.hanzo.ai` with `https://kms.hanzo.ai` or your self-hosted instance's URL in the request URL.
      </Note>
