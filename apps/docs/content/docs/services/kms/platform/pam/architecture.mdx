...
- **Upload**: Once the session concludes, the logs are securely uploaded to the Hanzo KMS platform for storage and review.
...
- **Outbound-Only**: The Gateway only requires outbound connectivity to the Relay server and Hanzo KMS API.
