---
title: "GitLab SSO"
description: "Learn how to configure GitLab SSO for Hanzo KMS."
---
...
<AccordionGroup>
  <Accordion title="Why is GitLab SSO not working?">
    ...
    For example, if the former is `https://app.kms.hanzo.ai/api/v1/sso/gitlab` then the latter should be `https://app.kms.hanzo.ai`.
  </Accordion>
</AccordionGroup>