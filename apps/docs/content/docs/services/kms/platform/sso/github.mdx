---
title: "GitHub SSO"
description: "Learn how to configure GitHub SSO for Hanzo KMS."
---
...
<Steps>
  ...
  <Step title="Add your OAuth application credentials to Hanzo KMS">
...
<AccordionGroup>
  <Accordion title="Why is GitHub SSO not working?">
    ...
    For example, if the former is `https://app.kms.hanzo.ai/api/v1/sso/github` then the latter should be `https://app.kms.hanzo.ai`.
  </Accordion>
</AccordionGroup>