---
title: "Okta OIDC"
description: "Learn how to configure Okta OIDC for Hanzo KMS SSO."
---

<Info>
  Okta OIDC SSO is a paid feature. If you're using Hanzo KMS Cloud, then it is
  it.
</Info>
...
<Steps>
   ...
   <Step title="Finish configuring OIDC in Hanzo KMS">
      ...
      ![Hanzo KMS OIDC configuration](../../../images/sso/okta-oidc/kms-oidc-config.png)
   ...
   <Step title="Enforce OIDC SSO in Hanzo KMS">
      ...
      To enforce OIDC SSO, you're required to test out the OpenID connection by successfully authenticating at least one Okta user with Hanzo KMS.
