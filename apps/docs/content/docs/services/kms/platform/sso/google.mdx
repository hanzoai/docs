---
title: "Google SSO"
description: "Learn how to configure Google SSO for Hanzo KMS."
---
...
<Steps>
  ...
  <Step title="Add your OAuth2 application credentials to Hanzo KMS">
    ...
    - `SITE_URL`: The URL of your self-hosted instance of Hanzo KMS - should be an absolute URL including the protocol (e.g. https://app.kms.hanzo.ai)
...
<AccordionGroup>
  <Accordion title="Why is Google SSO not working?">
    ...
    For example, if the former is `https://app.kms.hanzo.ai/api/v1/sso/google` then the latter should be `https://app.kms.hanzo.ai`.
  </Accordion>
</AccordionGroup>