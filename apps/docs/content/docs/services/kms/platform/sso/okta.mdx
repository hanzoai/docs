---
title: "Okta SAML"
description: "Learn how to configure Okta SAML 2.0 for Hanzo KMS SSO."
---

<Info>
  Okta SAML SSO is a paid feature. If you're using Hanzo KMS Cloud, then it is
  it.
</Info>
...
<Steps>
   ...
   <Step title="Finish configuring SAML in Hanzo KMS">
      Back in Hanzo KMS, set **Identity Provider Single Sign-On URL**, **Identity Provider Issuer**,
      ...
      ![SAML Okta paste values into Hanzo KMS](../../../images/sso/okta/idp-values-2.png)
   ...
   <Step title="Enforce SAML SSO in Hanzo KMS">
      ...
      To enforce SAML SSO, you're required to test out the SAML connection by successfully authenticating at least one Okta user with Hanzo KMS;
