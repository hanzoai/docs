...
customize settings and manage users for their entire Hanzo KMS instance.

<Note>
  The first user to setup an account on your Hanzo KMS instance is designated as
...
This tab allows you to set various rate limits for your Hanzo KMS instance. You do not need to redeploy when making changes to rate limits as these will be propagated automatically.
...
<Note>
  ...
  sales@hanzo.ai to purchase a license for its use.
</Note>
