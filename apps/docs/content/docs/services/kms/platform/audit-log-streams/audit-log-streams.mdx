    ...
    <Accordion title="Azure">
        ...
        <Steps>
            ...
            <Step title="Create a Custom Log Table">
                ...
                Configure the Custom Log Table: Provide a **Table name** (e.g., `HanzoKMSLogs`), select the **Data collection endpoint** created in Step 1, and create a new **Data collection rule** as illustrated in the image below. Then, click **Next**.
...
<ParamField path="userAgentType" type="web | cli | k8-operator | terraform | other | HanzoKMSPythonSDK | HanzoKMSNodeSDK">
