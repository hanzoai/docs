---
title: "Migrating from EnvKey to Hanzo KMS"
sidebarTitle: "EnvKey"
description: "Learn how to migrate secrets from EnvKey to Hanzo KMS."
---
...
<Steps>
  ...
  <Step title="Navigate to Hanzo KMS external migrations">
    Open the Hanzo KMS dashboard and go to Organization Settings > External Migrations.
    ![Hanzo KMS Organization settings](/images/platform/external-migrations/kms-external-migration-dashboard.png)
  </Step>
  ...
  <Step title="Upload the exported file from EnvKey">
    ...
    ![Hanzo KMS Import EnvKey](/images/platform/external-migrations/kms-import-envkey.png)
  </Step>
</Steps>
...
To make the migration process even more seamless, you can [schedule a meeting with our team](https://kms.hanzo.ai/talk-to-us) to learn more about how Hanzo KMS compares to EnvKey and discuss unique needs of your organization. You are also welcome to email us at [support@kms.hanzo.ai](mailto:support@kms.hanzo.ai) to ask any questions or get any technical help.
