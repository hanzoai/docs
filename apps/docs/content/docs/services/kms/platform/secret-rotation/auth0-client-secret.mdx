...
<Note>
  **Rotation Type: [Single-Phase](/documentation/platform/secret-rotation/overview#single-phase-rotation)**
  ...
  This is a limitation of the Auth0 platform and cannot be rectified by Hanzo KMS.
</Note>
...
## Create an Auth0 Client Secret Rotation in Hanzo KMS
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl --request POST \
        --url https://kms.hanzo.ai/api/v2/secret-rotations/auth0-client-secret \
