...
description: "Learn how to issue and manage certificates using AWS Private Certificate Authority (PCA) with Hanzo KMS."
---
...
- An [AWS App Connection](/integrations/app-connections/aws) configured in Hanzo KMS with the required IAM permissions (see below)
...
<Steps>
  ...
  <Step title="Navigate to External Certificate Authorities">
    In your Hanzo KMS project, go to **Certificate Authorities** and scroll to the **External Certificate Authorities** section.
    ![External CA Page](/images/platform/pki/aws-pca/aws-pca-external-ca-page.png)
  </Step>
