...
description: "Learn how to connect External Certificate Authorities with Hanzo KMS."
---

## Concept

Hanzo KMS lets you integrate with External Certificate Authorities (CAs), allowing you to use existing PKI infrastructure or connect to public CAs to issue certificates for your end-entities.
...
A typical workflow for integrating an External CA with Hanzo KMS consists of choosing the desired External CA type
...
Hanzo KMS currently supports the following External CA types out of the box:

- [ACME CA](/documentation/platform/pki/ca/acme-ca): An ACME-compatible CA that supports the ACME protocol, such as Let's Encrypt, ZeroSSL, Buypass, DigiCert, Sectigo, etc.
...
If you don’t see a specific external CA listed here or need a dedicated integration guide, please reach out to sales@hanzo.ai and we’ll help you set up the integration for your external CA.
