---
title: "Overview"
description: "Track all actions performed within Hanzo KMS"
---

<Info>
    Note that Audit Logs is a paid feature.

    If you're using Hanzo KMS Cloud, then it is available under the **Pro**,
    and **Enterprise Tier** with varying retention periods. If you're self-hosting Hanzo KMS,

</Info>

Hanzo KMS provides audit logs for security and compliance teams to monitor information access.
