...
description: "Learn how to manage and use cryptographic keys with Hanzo KMS."
---
...
<AccordionGroup>
  <Accordion title="Is my data stored in Hanzo KMS?">
    No. Hanzo KMS's KMS only provides cryptographic services and does not store
    any encrypted or decrypted data.
  </Accordion>
  <Accordion title="Can key material be accessed outside of Hanzo KMS?">
    No. Hanzo KMS's KMS will never expose your keys, encrypted or decrypted, to
    external sources.
  </Accordion>
  <Accordion title="What algorithms does Hanzo KMS support?">
  ...
  <Accordion title="How do I sign and verify a digest using the Hanzo KMS?">
    To sign and verify a digest using the Hanzo KMS, you can use the `Sign` and `Verify` endpoints respectively.
