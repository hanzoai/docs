...
In the following steps, we explore how to create and use groups to provision access to projects in Hanzo KMS. Groups can contain both users and machine identities, and the workflow is the same for both types of identities.
