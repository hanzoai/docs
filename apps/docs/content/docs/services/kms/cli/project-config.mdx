...
To link your local project on your machine with a Hanzo KMS project, we suggest using the kms init CLI command. This will generate a `.kms.json` file in the root directory of your project.
