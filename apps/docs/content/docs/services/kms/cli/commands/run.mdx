...
Inject secrets from Hanzo KMS into your application process.
...
### Flags
  ...
  <Accordion title="--watch">
    By passing the `watch` flag, you are telling the CLI to watch for changes that happen in your Hanzo KMS project.
