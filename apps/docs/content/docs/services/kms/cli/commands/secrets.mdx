---
title: "kms secrets"
description: "Perform CRUD operations with Hanzo KMS secrets"
---
...
This command allows you to generate an example .env file from your secrets and with their associated comments and tags. This is useful when you would like to let 
 others who work on the project but do not use Hanzo KMS become aware of the required environment variables and their intended values.
