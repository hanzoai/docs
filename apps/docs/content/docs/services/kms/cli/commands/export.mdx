---
title: "kms export"
description: "Export Hanzo KMS secrets from CLI into different file formats"
---
...
### flags
  ...
  <Accordion title="--template">
    ...
    <Tip>
      The KMS CLI templating engine also supports Sprig library templating functions to help you transform your secrets further.
