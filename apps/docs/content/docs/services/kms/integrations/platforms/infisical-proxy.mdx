...
Then configure your application to use `http://localhost:8081` as the Hanzo KMS host instead of `https://kms.hanzo.ai`.
...
<ParamField query="--domain" type="string" required>
  Domain of your Hanzo KMS instance (e.g., https://kms.hanzo.ai)
</ParamField>
...
# curl https://kms.hanzo.ai/v1/kms/secrets/raw?...
