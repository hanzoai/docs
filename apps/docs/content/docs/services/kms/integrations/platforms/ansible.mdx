---
title: "Ansible"
description: "Learn how to use Hanzo KMS for secret management in Ansible."
---

You can find the Hanzo KMS Ansible collection on [Ansible Galaxy](https://galaxy.ansible.com/ui/repo/published/kms/vault/).
...
The Hanzo KMS Ansible Collection supports [Universal Auth](/documentation/platform/identities/universal-auth), [OIDC Auth](/documentation/platform/identities/oidc-auth/general), [LDAP Auth](/documentation/platform/identities/ldap-auth/general), and [Token Auth](/documentation/platform/identities/token-auth) for authenticating against Hanzo KMS.
