...
The **KMSDynamicSecret** CRD allows you to easily create and manage dynamic secret leases in Hanzo KMS and automatically sync them to your Kubernetes cluster as native **Kubernetes Secret** resources.
...
The example below shows a sample **KMSDynamicSecret** CRD that creates a dynamic secret lease in Hanzo KMS, and syncs the lease to your Kubernetes cluster.
...
After applying the KMSDynamicSecret CRD, you should notice that the dynamic secret lease has been created in Hanzo KMS and synced to your Kubernetes cluster. You can verify that the lease has been created by doing:
...
Once you have configured the `KMSDynamicSecret` CRD with the required fields, you can apply it to your cluster. After applying, you should notice that a lease has been created in Hanzo KMS and synced to your Kubernetes cluster.
