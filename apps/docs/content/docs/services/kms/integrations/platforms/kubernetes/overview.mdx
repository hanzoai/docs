...
1. [KMSSecret](/integrations/platforms/kubernetes/kms-secret-crd): Sync secrets from Hanzo KMS to a Kubernetes secret.
2. [KMSPushSecret](/integrations/platforms/kubernetes/kms-push-secret-crd): Push secrets from a Kubernetes secret to Hanzo KMS.
...
Status:
  Conditions:
    ...
    Reason:                OK
    Status:                True
    Type:                  secrets.kms.hanzo.ai/LoadedHanzoKMSToken
