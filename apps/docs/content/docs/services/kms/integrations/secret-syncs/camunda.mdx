---
title: "Camunda Sync"
description: "Learn how to configure a Camunda Sync for Hanzo KMS."
---
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        ...
        ![Configure Options](/images/secret-syncs/camunda/camunda-options.png)
            ...
            - **Initial Sync Behavior**: Determines how Hanzo KMS should resolve the initial sync.
                ...
                - **Import Secrets (Prioritize Hanzo KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Hanzo KMS over Camunda when keys conflict.
                - **Import Secrets (Prioritize Camunda)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Camunda over Hanzo KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://app.kms.hanzo.ai/api/v1/secret-syncs/camunda \
