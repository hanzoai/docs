...
description: "Learn how to configure a Databricks Sync for Hanzo KMS."
---
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        ...
        ![Configure Destination](/images/secret-syncs/databricks/databricks-destination.png)
            ...
            <Note>
                ...
                Hanzo KMS recommends creating a designated Databricks secret scope for your sync to prevent removal of secrets not managed by Hanzo KMS.
            </Note>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://app.kms.hanzo.ai/api/v1/secret-syncs/databricks \
