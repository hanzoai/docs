---
title: "Vercel Sync"
description: "Learn how to configure a Vercel Sync for Hanzo KMS."
---
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        ...
        ![Configure Options](/images/secret-syncs/vercel/vercel-options.png)
            ...
            <Note>
                Vercel does not expose the values of [sensitive environment variables](https://vercel.com/docs/environment-variables/sensitive-environment-variables), so Hanzo KMS cannot import them during the initial sync. As a result, these secrets are created in Hanzo KMS with empty values. After the first sync, you'll need to manually re-enter their values in Hanzo KMS to ensure both platforms stay aligned.
            </Note>
