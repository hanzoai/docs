---
title: "Zabbix Sync"
description: "Learn how to configure a Zabbix Sync for Hanzo KMS."
---
...
<Tabs>
        ...
        <Steps>
            ...
            <Step title="Configure Sync Options">
                ...
                - **Initial Sync Behavior**: Determines how Hanzo KMS should resolve the initial sync.
                    ...
                    - **Import Secrets (Prioritize Hanzo KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Hanzo KMS over Zabbix when keys conflict.
                    - **Import Secrets (Prioritize Zabbix)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Zabbix over Hanzo KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://app.kms.hanzo.ai/api/v1/secret-syncs/zabbix \
