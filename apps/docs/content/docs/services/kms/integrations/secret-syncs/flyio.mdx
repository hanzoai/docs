---
title: "Fly.io Sync"
description: "Learn how to configure a Fly.io Sync for Hanzo KMS."
---
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        <Steps>
            ...
            <Step title="Configure sync options">
                ...
                - **Auto Redeploy On Secret Change**: If enabled, Hanzo KMS will restart all app machines after syncing or removing secrets so they pick up the new values immediately.
                <Note>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://app.kms.hanzo.ai/api/v1/secret-syncs/flyio \
