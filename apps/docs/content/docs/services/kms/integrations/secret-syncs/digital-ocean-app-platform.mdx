...
description: "Learn how to configure a DigitalOcean App Platform Sync for Hanzo KMS."
---
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://app.kms.hanzo.ai/api/v1/secret-syncs/digital-ocean-app-platform \
