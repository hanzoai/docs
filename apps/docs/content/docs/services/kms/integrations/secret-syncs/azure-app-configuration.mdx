...
description: "Learn how to configure an Azure App Configuration Sync for Hanzo KMS."
---
...
<Note>
  ...
  for Hanzo KMS to sync secrets to Azure App Configuration: `Read Key-Value`, `Write Key-Value`, `Delete Key-Value`.
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        ...
        ![Configure Destination](/images/secret-syncs/azure-app-configuration/app-config-destination.png)
            ...
            - **Label**: An optional label to attach to all secrets created by Hanzo KMS inside your Azure App Configuration.
        ...
        ![Configure Options](/images/secret-syncs/azure-app-configuration/app-config-options.png)
            ...
            - **Initial Sync Behavior**: Determines how Hanzo KMS should resolve the initial sync.
                ...
                - **Import Secrets (Prioritize Azure App Configuration)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Secrets Manager over Hanzo KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
        --url https://app.kms.hanzo.ai/api/v1/secret-syncs/azure-app-configuration \
