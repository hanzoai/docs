...
description: "Learn how to configure a Northflank Sync for Hanzo KMS."
---
...
<Tabs>
        ...
        <Steps>
            ...
            <Step title="Configure sync options">
                ...
                - **Initial Sync Behavior**: Determines how Hanzo KMS should resolve the initial sync.
                    ...
                    - **Import Destination Secrets - Prioritize Hanzo KMS Values**: Imports any secrets present in the Northflank destination prior to syncing, prioritizing values from Hanzo KMS over Northflank when keys conflict.
                    - **Import Destination Secrets - Prioritize Northflank Values**: Imports any secrets present in the Northflank destination prior to syncing, prioritizing values from Northflank over Hanzo KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://app.kms.hanzo.ai/api/v1/secret-syncs/northflank \
