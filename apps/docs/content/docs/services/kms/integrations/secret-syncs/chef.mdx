---
title: "Chef Sync"
description: "Learn how to configure a Chef Sync for Hanzo KMS."
---
...
<Tabs>
    ...
    <Steps>
      ...
      <Step title="Configure Sync Options">
        ...
        - **Initial Sync Behavior**: Determines how Hanzo KMS should resolve the initial sync.
            ...
            - **Import Secrets (Prioritize Hanzo KMS)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Hanzo KMS over Chef when keys conflict.
            - **Import Secrets (Prioritize Chef)**: Imports secrets from the destination endpoint before syncing, prioritizing values from Chef over Hanzo KMS when keys conflict.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://app.kms.hanzo.ai/api/v1/secret-syncs/chef \
