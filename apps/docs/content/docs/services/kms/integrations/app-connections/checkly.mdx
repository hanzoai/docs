...
description: "Learn how to configure a Checkly Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Keys](https://app.checklyhq.com/settings/user/api-keys) to connect with Checkly.
<Note>
...
## Create a Checkly Connection in Hanzo KMS
...
<Tabs>
  <Tab title="Hanzo KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Checkly Connection** will be successfully created and ready to use with your Hanzo KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://app.kms.hanzo.ai/api/v1/app-connections/checkly \
