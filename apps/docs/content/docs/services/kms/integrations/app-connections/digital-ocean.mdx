...
description: "Learn how to configure a DigitalOcean Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://cloud.digitalocean.com/account/api/tokens) to connect with DigitalOcean.
