...
description: "Learn how to configure an Oracle Cloud Infrastructure Connection for Hanzo KMS."
---
...
Hanzo KMS supports the use of [API Signing Key Authentication](https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm) to connect with OCI.
