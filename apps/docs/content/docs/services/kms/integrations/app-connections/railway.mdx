...
description: "Learn how to configure a Railway Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://docs.railway.com/guides/public-api#creating-a-token) to connect with Railway.
