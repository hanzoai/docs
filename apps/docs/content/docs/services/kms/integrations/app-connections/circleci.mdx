...
description: "Learn how to configure a CircleCI Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://app.circleci.com/settings/user/tokens) to connect with CircleCI.
<Note>
...
<Steps>
  ...
  <Step title="In the user settings sidebar, select 'Personal API Tokens'">
   ...
   <Step title="Set a name for the token and click 'Add API Token'">
    ...
    You will need this token to configure your Hanzo KMS connection
