...
description: "Learn how to configure a Netlify Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Personal Access Tokens](https://docs.netlify.com/api/get-started/#get-access-tokens) to connect with Netlify.  
<Note>
