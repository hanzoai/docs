...
description: "Learn how to configure a Zabbix Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://www.zabbix.com/documentation/current/en/manual/web_interface/frontend_sections/users/api_tokens) to connect with Zabbix.
