...
description: "Learn how to configure a Supabase Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Personal Access Tokens](https://supabase.com/dashboard/account/tokens) to connect with Supabase.
