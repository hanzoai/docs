...
description: "Learn how to configure an Okta Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://developer.okta.com/docs/guides/create-an-api-token/main/) to connect with Okta.
