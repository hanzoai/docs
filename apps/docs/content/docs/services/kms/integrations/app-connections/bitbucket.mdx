...
description: "Learn how to configure a Bitbucket Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://support.atlassian.com/bitbucket-cloud/docs/api-tokens/) to connect with Bitbucket.
