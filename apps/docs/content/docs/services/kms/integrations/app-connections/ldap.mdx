...
description: "Learn how to configure an LDAP Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Simple Binding](https://ldap.com/the-ldap-bind-operation) to connect with your LDAP provider.
...
## Setup LDAP Connection in Hanzo KMS
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
            --url https://app.kms.hanzo.ai/api/v1/app-connections/ldap \
