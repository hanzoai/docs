...
description: "Learn how to configure a TeamCity Connection for Hanzo KMS."
---
...
<Steps>
    ...
    <Step title="Create the Access Token">
        Click the **Create access token** button and provide a name for your token (e.g., "Hanzo KMS Integration"). You may set an expiration date or leave it blank for no expiry.
    ...
    <Step title="Setup TeamCity Connection in Hanzo KMS">
        <Tabs>
