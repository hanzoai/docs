...
description: "Learn how to configure a DBT Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Personal Access Tokens](https://docs.getdbt.com/docs/dbt-cloud-apis/user-tokens) to connect with DBT.
