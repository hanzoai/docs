...
description: "Learn how to configure a Vercel Connection for Hanzo KMS."
---

Hanzo KMS supports connecting to Vercel using API Tokens.

## Setup Vercel Connection in Hanzo KMS
...
<Steps>
    ...
    <Step title="Create the API Token">
        Click the **Create** button and provide a name for your token (e.g., "Hanzo KMS Integration"). 
    ...
    <Step title="Setup Vercel Connection in Hanzo KMS">
        <Tabs>
            <Tab title="Hanzo KMS UI">
                ...
                4. Connection Created
                    ...
                    After clicking Create, your **Vercel Connection** is established and ready to use with your Hanzo KMS project.
            ...
            <Tab title="API">
                ...
                ```bash Request
                curl    --request POST \
                        --url https://app.kms.hanzo.ai/api/v1/app-connections/vercel \
