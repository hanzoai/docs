...
description: "Learn how to configure an Octopus Deploy Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Keys](https://octopus.com/docs/octopus-rest-api/how-to-create-an-api-key) to connect with Octopus Deploy.
