...
description: "Learn how to configure an OpenRouter (LLM router) connection for Hanzo KMS."
---

[OpenRouter](https://openrouter.ai/) is a unified LLM router that gives you access to hundreds of large language models through a single API. Hanzo KMS supports connecting to OpenRouter using an **API Key** (Provisioning API key). This connection is used to manage and rotate OpenRouter API keys via [Secret Rotation](/documentation/platform/secret-rotation/openrouter-api-key).
    ...
    <Tab title="Hanzo KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking **Create**, Hanzo KMS validates the key against OpenRouter's API. Your **OpenRouter Connection** is then ready to use for [OpenRouter API Key Secret Rotation](/documentation/platform/secret-rotation/openrouter-api-key).
