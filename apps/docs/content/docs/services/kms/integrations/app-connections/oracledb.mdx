...
description: "Learn how to configure a Oracle Database Connection for Hanzo KMS."
---
...
<Tabs>
    <Tab title="Hanzo KMS UI">
        ...
        <Note>
            Optionally, if you'd like Hanzo KMS to manage the credentials of this connection, you can enable the Platform Managed Credentials option.
            If enabled, Hanzo KMS will update the password of the connection on creation to prevent external access to this database user.
        </Note>
