...
<Tabs>
    <Tab title="App Role (Recommended)">
        <Steps>
            <Step title="Navigate to Vault Access">
                ![Vault Access](/images/app-connections/external-secret-manager/vault-access.png)
            </Step>
            <Step title="Enable New Method">
                In the **Authentication Methods** tab, click on **Enable new method**.

                ![Vault Enable Method](/images/app-connections/external-secret-manager/vault-authentication-methods.png)
            </Step>
            <Step title="Select AppRole">
                ![Vault AppRole](/images/app-connections/external-secret-manager/vault-approle.png)
            </Step>
            <Step title="Enable Method">
                You may change the name of the method, but we suggest keeping it as `approle`.

                ![Vault Enable Method](/images/app-connections/external-secret-manager/vault-enable-method.png)
            </Step>
            <Step title="Navigate to Vault Policies">
                From the home page, navigate to **Policies**.

                ![Vault Policies Navigate](/images/app-connections/external-secret-manager/vault-policies-navigate.png)
            </Step>
            <Step title="Create ACL Policy">
                ![Vault Policies Page](/images/app-connections/external-secret-manager/vault-policies-page.png)
            </Step>
            <Step title="Create Policy">
                ...
                ![Vault Create Policy](/images/app-connections/external-secret-manager/vault-create-policy.png)
            </Step>
            <Step title="Run Shell Commands">
                **Open Vault Shell**

                ![Vault Shell](/images/app-connections/external-secret-manager/vault-shell.png)
                ...
                **Generate New SecretID**
                ...
                ![Vault Shell Output](/images/app-connections/external-secret-manager/vault-shell-output.png)
            </Step>
        </Steps>
    </Tab>
    <Tab title="Access Token">
        ...
        ![Vault Profile Copy Token](/images/app-connections/external-secret-manager/vault-profile-token.png)
    </Tab>
</Tabs>
...
<Tab title="Self Hosted">
    ...
    <Tab title="Hashicorp Cloud Platform">
        ...
        ![Vault Cluster URLs](/images/app-connections/external-secret-manager/vault-cluster-urls.png)
    ...
    <Tab title="Hanzo KMS UI">
        <Steps>
            ...
            <Step title="Add Connection">
                ...
                ![Select Vault Connection](/images/app-connections/external-secret-manager/vault-kms-connect-page.png)
            </Step>
            <Step title="Configure Connection">
                ...
                ![Vault Configure Connection](/images/app-connections/external-secret-manager/vault-kms-connect-modal.png)
            ...
            <Step title="Connection Created">
                ...
                ![Vault Connection Created](/images/app-connections/external-secret-manager/vault-kms-connect-success.png)
            </Step>
        </Steps>
    </Tab>
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/app-connections/external-secret-manager \
