...
description: "Learn how to configure a Fly.io Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Access Tokens](https://fly.io/docs/security/tokens/) to connect with Fly.io.
