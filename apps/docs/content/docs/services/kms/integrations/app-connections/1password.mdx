...
description: "Learn how to configure a 1Password Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [Service Accounts](https://developer.1password.com/docs/service-accounts) to connect with 1Password.
