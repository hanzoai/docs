...
description: "Learn how to configure a Northflank Connection for Hanzo KMS."
---

Hanzo KMS supports the use of [API Tokens](https://northflank.com/docs/v1/api/use-the-api) to connect with Northflank.
