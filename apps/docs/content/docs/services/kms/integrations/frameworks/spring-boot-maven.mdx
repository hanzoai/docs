...
description: "How to use Hanzo KMS to inject environment variables into Java Spring Boot"
---

Prerequisites:

- Set up and add your environment variables to [Hanzo KMS Cloud](https://app.kms.hanzo.ai)
...
To pass in Hanzo KMS secrets into your application, we will utilize the KMS CLI to inject the secrets into the Maven wrapper executable, which is used to launch your application. 
