...
- Hanzo KMS (you can use [Hanzo KMS Cloud](https://app.kms.hanzo.ai) or a [self-hosted instance of Hanzo KMS](https://kms.hanzo.ai/docs/self-hosting/overview)) to store your secrets
