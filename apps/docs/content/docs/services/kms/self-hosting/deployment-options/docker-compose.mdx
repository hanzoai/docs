...
description: "Deploy Hanzo KMS using Docker Compose for development, testing, or small-scale production environments."
---
...
<Warning>
  ...
  It includes just the essential components needed to set up a Hanzo KMS proof of concept (POC). 
  To run Hanzo KMS in a highly available manner, see the [Docker Swarm guide](/self-hosting/deployment-options/docker-swarm) or [Kubernetes guide](/self-hosting/deployment-options/kubernetes-helm).
</Warning>
