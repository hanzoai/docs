...
description: "Deploy Hanzo KMS securely on Google Cloud Platform using GKE, Cloud SQL, and Memorystore."
---
...
- [Helm](https://helm.sh/docs/intro/install/) installed (version 3.x) for deploying the Hanzo KMS Helm chart
...
<Step title="Deploy Hanzo KMS using Helm">
...
<AccordionGroup>
  ...
  <Accordion title="Upgrade Instructions">
    **Pre-upgrade checklist:**
    1. Review Hanzo KMS release notes for breaking changes
