...
Hanzo Cloud reaches our own models — `enso` and Zen — through `api.hanzo.ai`
with your existing key, and that is the default. Add one of the providers
below when a workflow needs a specific model from it.

| Provider | Models & Features |
|----------|-------------------|
| [Hanzo](https://api.hanzo.ai) | `enso`, `enso-flash`, `enso-ultra`, `zen5`, `zen5-pro`, `zen5-coder`, `zen-embedding`. First-party, no extra key. |
