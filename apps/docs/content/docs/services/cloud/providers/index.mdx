...
We support Hanzo S3 -- and any other S3-compatible endpoint, via the S3 provider type with its endpoint set -- plus AWS S3, Azure Blob Storage, Alibaba Cloud OSS and Tencent Cloud COS. More cloud storage services are added over time.
