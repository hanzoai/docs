...
- **Versatile**: Supports a wide range of databases, including MySQL, SQL, DocumentDB, KV, and more.
...
- [SQL](https://kubeblocks.io/docs/preview/kubeblocks-for-postgresql/02-quickstart)
- [DocumentDB](https://kubeblocks.io/docs/preview/kubeblocks-for-mongodb/02-quickstart)
- [KV](https://kubeblocks.io/docs/preview/kubeblocks-for-redis/02-quickstart)
