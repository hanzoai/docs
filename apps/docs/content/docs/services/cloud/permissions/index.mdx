...
Hanzo Cloud integrates with [Hanzo IAM](/docs/basic/iam-sso) for user authentication and SSO. User roles and permissions are managed through Hanzo IAM and synchronized automatically with Hanzo Cloud.
