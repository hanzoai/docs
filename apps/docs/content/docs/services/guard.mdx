...
# guard-proxy sits in front of the API; point the client at it
client = Hanzo(
    api_key="your-key",
...
<Cards>
  <Card title="Gateway" href="/docs/services/gateway">
    The API gateway in front of Hanzo Cloud — routing, rate limiting, telemetry
  </Card>
  <Card title="Cloud" href="/docs/services/cloud">
    Cloud Backend — inference, knowledge bases, and model management
  </Card>
