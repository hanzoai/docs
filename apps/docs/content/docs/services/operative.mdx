...
Operative handles browser-based tasks. The model sees the screen via screenshots and interacts using mouse and keyboard tools.
...
<Cards>
  ...
  <Card title="Hanzo Agent" href="/docs/services/agents">
    Multi-agent SDK for orchestrating tool use, planning, memory, and cross-agent coordination.
  </Card>
</Cards>
