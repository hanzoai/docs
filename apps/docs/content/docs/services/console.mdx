...
Sign in at `console.hanzo.ai` with Hanzo IAM SSO. Navigate to **Settings > API Keys** and create a new key. Keys are scoped to a project and prefixed with `sk-`.
...
const console = new ConsoleClient({ publicKey: 'pk-your-api-key' })
