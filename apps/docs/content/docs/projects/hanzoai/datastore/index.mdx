    ...
    return (
        ...
        >
            <div>
                ...
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ integrations to connect the tools and services that you love with Datastore.</span>
            </div>
...
export const HighlightedDatastore = () => {
    return (
        <span className="relative inline-block px-8 py-3 -ml-4">
            ...
            <span className="relative z-10 text-white dark:text-[#1c1c1c]">Datastore</span>
        </span>
    );
};
...
<div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
        ...
        <h1 className="block text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
            Start building with <HighlightedDatastore />
        </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
            <HeroCard
                ...
                links={[
                    { label: "What is Datastore?", href: "/get-started/about/intro" },
                    { label: "Install", href: "/get-started/setup/cloud" },
                    { label: "Quickstarts", href: "/get-started/quickstarts/home" },
                    { label: "Datastore concepts", href: "/concepts/core-concepts/index" },
            ...
            <HeroCard
                ...
                description="I want to accomplish a specific task with Datastore"
                href="/guides/datastore"
                icon={
                ...
                links={[
                    { label: "Modelling data", href: "/guides/datastore/data-modelling/schema-design" },
                    { label: "Optimizing performance", href: "/guides/datastore/performance-and-monitoring/query-optimization" },
                    { label: "Datastore Cloud", href: "/products/cloud/guides" },
            ...
            <HeroCard
                ...
                description="I want to explore Datastore solutions"
                ...
                links={[
                    { label: "Datastore Cloud", href: "/products/cloud/getting-started/cloud-get-started" },
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Discover how Datastore powers real-time analytics, observability, data warehousing, and agentic AI at any scale.</p>
        <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
            ...
            <HeroCard
                ...
                description="Store and query logs, metrics and traces at scale using ClickStack, the open source observability stack powered by Datastore."
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Browse Datastore products and integrations, from the managed cloud service to open source projects.</p>
        <div className="space-y-4 mt-6">
            {/* Row 1: Datastore Cloud (col-span-2) + 2 stacked cards (col-span-1) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
                <div className="col-span-2">
                    <HeroCard
                        ...
                        imageTop
                        imageHeight="h-[340px]"
                        title="Datastore Cloud"
                        galaxyEvent="docs.home.datastore-cloud"
                        ...
                        links={[
                            ...
                            { label: "2. Best practices for organizing data for analytics and growth", href: "/guides/datastore/data-modelling/schema-design" },
                ...
                <div className="flex flex-col gap-4">
                    <HeroCard
                        ...
                        description="The all in one observability stack powered by Datastore, which gives you lightning-fast queries and powerful aggregations on logs, metrics, traces, session replays and errors."
                        href="/clickstack/overview"
                    ...
                    <HeroCard
                        ...
                        description="Fast, scalable, enterprise-grade Postgres service, natively integrated with Datastore. Easily combine Postgres for transactions and Datastore for analytics."
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <HeroCard
                    ...
                    description="Automates deploying, configuring, and managing Datastore and Datastore Keeper clusters on Kubernetes."
                ...
                <HeroCard
                    ...
                    description="A fast, reliable, and scalable in-process database. Experience the power of Datastore, in-process."
                    href="/chdb/index"
                    showArrow
                />
            </div>
        ...
        <div id="mcp-setup" className="mt-16 scroll-mt-20">
            ...
            <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Query the Datastore documentation directly from your AI tools using the Model Context Protocol.</p>
            <div className="mt-6">
                <Tabs>
                    <Tab title="Claude Code" icon="https://datastore-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                        <p className="mb-2 text-[#9ca3af] text-[13px]">Run in your terminal:</p>
                        <CodeBlock language="bash">{`claude mcp add --transport http datastore-docs https://private-7c7dfe99.mintlify.app/mcp --scope user`}</CodeBlock>
                    </Tab>
                    <Tab title="Claude Desktop" icon="https://datastore-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                    ...
                    <Tab title="Cursor" icon="https://datastore-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                        <p className="mb-2 text-[#9ca3af] text-[13px]">Add to <code>.cursor/mcp.json</code>:</p>
                        <CodeBlock language="json">{mcpJsonConfig}</CodeBlock>
                    </Tab>
                    <Tab title="Windsurf" icon="https://datastore-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
            ...
            <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
                <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Add Datastore skills to your coding agent</p>
                <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Install the Datastore skills to give your agent expert Datastore knowledge and best practices.</p>
