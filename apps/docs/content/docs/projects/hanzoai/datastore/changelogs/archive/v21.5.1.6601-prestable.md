...
* Add log_comment setting for DROP/CREATE DATABASE in datastore-test [#22646](https://github.com/ClickHouse/ClickHouse/pull/22646) ([Azat Khuzhin](https://github.com/azat)).
