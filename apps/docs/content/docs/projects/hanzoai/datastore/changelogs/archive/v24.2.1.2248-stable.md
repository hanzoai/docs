...
* Add new config setting `backups.remove_backup_files_after_failure`: ``` <datastore> <backups> <remove_backup_files_after_failure>true</remove_backup_files_after_failure> </backups> </datastore> ```. [#60002](https://github.com/ClickHouse/ClickHouse/pull/60002) ([Vitaly Baranov](https://github.com/vitlibar)).
