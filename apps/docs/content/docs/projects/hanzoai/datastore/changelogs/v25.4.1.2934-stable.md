...
* tests: remove --print-time option for datastore-test (always print them). [#78091](https://github.com/ClickHouse/ClickHouse/pull/78091) ([Azat Khuzhin](https://github.com/azat)).
