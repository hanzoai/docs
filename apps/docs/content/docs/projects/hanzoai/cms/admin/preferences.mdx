...
Preferences are available to both [GraphQL](/docs/projects/hanzoai/cms/graphql/overview#preferences) and [REST](/docs/projects/hanzoai/cms/rest-api/overview#preferences) APIs.
