...
<CardGroup>
  <Card
    ...
    link="/docs/projects/hanzoai/cms/local-api/overview"
  />
  <Card
    title="REST API"
    ...
    link="/docs/projects/hanzoai/cms/rest-api/overview"
  />
  <Card
    title="GraphQL"
    ...
    link="/docs/projects/hanzoai/cms/graphql/overview"
  />
</CardGroup>
