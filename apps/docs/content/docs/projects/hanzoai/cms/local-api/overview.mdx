...
| `locale`             | Specify [locale](/docs/projects/hanzoai/cms/configuration/localization) for any returned documents.                                                                                                                                                                                                                                                                                        |
...
| `fallbackLocale`     | Specify a [fallback locale](/docs/projects/hanzoai/cms/configuration/localization) to use for any returned documents. This can be a single locale or array of locales.                                                                                                                                                                                                                     |
...
| `context`            | [Context](/docs/projects/hanzoai/cms/hooks/context), which will then be passed to `context` and `req.context`, which can be read by hooks. Useful if you want to pass additional information to the hooks which shouldn't be necessarily part of the document, for example a `triggerBeforeChange` option which can be read by the BeforeChange hook to determine if it should run or not. |
...
<Banner type="info">
  ...
  here](/docs/projects/hanzoai/cms/queries/pagination).
</Banner>
...
If a collection has [`Authentication`](/docs/projects/hanzoai/cms/authentication/overview) enabled, additional Local API operations will be
available:
...
Local API calls will automatically infer your [generated types](/docs/projects/hanzoai/cms/typescript/generating-types).
