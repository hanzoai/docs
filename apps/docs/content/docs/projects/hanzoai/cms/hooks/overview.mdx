...
- [Collection Hooks](/docs/projects/hanzoai/cms/hooks/collections)
- [Global Hooks](/docs/projects/hanzoai/cms/hooks/globals)
- [Field Hooks](/docs/projects/hanzoai/cms/hooks/fields)
...
To add Root Hooks, use the `hooks` property in your [Payload Config](/docs/projects/hanzoai/cms/configuration/overview):
