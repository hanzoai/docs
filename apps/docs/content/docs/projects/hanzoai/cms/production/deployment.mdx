...
Payload runs fully in Next.js, so the [Next.js build process](https://nextjs.org/docs/app/building-your-application/deploying) is used for building Payload. If you've used `@hanzo/create-cms-app` to create your project, executing the `build`
...
can [enable secure cookies](/docs/projects/hanzoai/cms/authentication/overview) in your Authentication-enabled Collection configs.
...
more. [Click here to learn more](/docs/projects/hanzoai/cms/production/preventing-abuse).
...
You can also add [`indexSortableFields`](/docs/projects/hanzoai/cms/configuration/overview) to index all sortable fields for the admin UI.

## File storage

If you are using Payload to [manage file uploads](/docs/projects/hanzoai/cms/upload/overview), you need to consider where your uploaded files
