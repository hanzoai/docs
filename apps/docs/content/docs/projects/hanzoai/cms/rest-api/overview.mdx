...
- [locale](/docs/projects/hanzoai/cms/configuration/localization#retrieving-localized-docs) - retrieves document(s) in a specific locale
- [fallback-locale](/docs/projects/hanzoai/cms/configuration/localization#retrieving-localized-docs) - specifies a fallback locale if no locale value exists
...
- [joins](/docs/projects/hanzoai/cms/fields/join#rest-api) - specifies the custom request for each join field by name of the field
...
- [sort](/docs/projects/hanzoai/cms/queries/overview#sort) - sort by field
- [where](/docs/projects/hanzoai/cms/queries/overview) - pass a where query to constrain returned documents
- [limit](/docs/projects/hanzoai/cms/queries/pagination#pagination-controls) - limit the returned documents to a certain number
- [page](/docs/projects/hanzoai/cms/queries/pagination#pagination-controls) - get a specific page of documents
  `
  },
  },
  {
...
In addition to the dynamically generated endpoints above Payload also has REST endpoints to manage the admin user [preferences](/docs/projects/hanzoai/cms/admin/preferences) for data specific to the authenticated user.
