...
![https://www.npmjs.com/package/@hanzo/cms-plugin-seo](https://img.shields.io/npm/v/@hanzo/cms-plugin-seo)
...
import type { GenerateTitle } from '@hanzo/cms-plugin-seo/types'
