...
![https://www.npmjs.com/package/@hanzo/cms-plugin-multi-tenant](https://img.shields.io/npm/v/@hanzo/cms-plugin-multi-tenant)
...
```tsx
import { useTenantSelection } from '@hanzo/cms-plugin-multi-tenant/client'
