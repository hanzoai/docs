...
![https://www.npmjs.com/package/@hanzo/cms-plugin-stripe](https://img.shields.io/npm/v/@hanzo/cms-plugin-stripe)
...
```bash
  pnpm add @hanzo/cms-plugin-stripe
```
...
```ts
import { stripeProxy } from '@hanzo/cms-plugin-stripe'
