...
![https://www.npmjs.com/package/@hanzo/cms-plugin-search](https://img.shields.io/npm/v/@hanzo/cms-plugin-search)
...
```bash
  pnpm add @hanzo/cms-plugin-search
```
...
```ts
import type { SearchConfig, BeforeSync } from '@hanzo/cms-plugin-search/types'
```
