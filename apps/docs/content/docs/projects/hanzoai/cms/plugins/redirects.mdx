...
![https://www.npmjs.com/package/@hanzo/cms-plugin-redirects](https://img.shields.io/npm/v/@hanzo/cms-plugin-redirects)
...
```ts
import { PluginConfig } from '@hanzo/cms-plugin-redirects/types'
```
