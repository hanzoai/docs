...
![https://www.npmjs.com/package/@hanzo/cms-plugin-form-builder](https://img.shields.io/npm/v/@hanzo/cms-plugin-form-builder)
...
```bash
pnpm add @hanzo/cms-plugin-form-builder
```
...
```ts
import type { BeforeEmail } from '@hanzo/cms-plugin-form-builder'
...
```ts
// payload.config.ts
import { getPaymentTotal } from '@hanzo/cms-plugin-form-builder'
```
...
```ts
import { fields } from '@hanzo/cms-plugin-form-builder'
```
...
```ts
import { fields as formFields } from '@hanzo/cms-plugin-form-builder'
