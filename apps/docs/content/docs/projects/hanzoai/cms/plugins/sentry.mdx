...
![https://www.npmjs.com/package/@hanzo/cms-plugin-sentry](https://img.shields.io/npm/v/@hanzo/cms-plugin-sentry)
...
```bash
  pnpm add @hanzo/cms-plugin-sentry
```
...
```ts
import { PluginOptions } from '@hanzo/cms-plugin-sentry'
```
