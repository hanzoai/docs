...
![https://www.npmjs.com/package/@hanzo/cms-plugin-nested-docs](https://img.shields.io/npm/v/@hanzo/cms-plugin-nested-docs)
...
```bash
  pnpm add @hanzo/cms-plugin-nested-docs
```
...
import { createParentField } from '@hanzo/cms-plugin-nested-docs'
import { createBreadcrumbsField } from '@hanzo/cms-plugin-nested-docs'
