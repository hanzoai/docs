...
![https://www.npmjs.com/package/@hanzo/cms-plugin-mcp](https://img.shields.io/npm/v/@hanzo/cms-plugin-mcp)
...
```ts
import { type MCPAccessSettings, mcpPlugin } from '@hanzo/cms-plugin-mcp'
