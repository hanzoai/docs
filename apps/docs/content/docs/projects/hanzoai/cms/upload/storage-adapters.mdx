...
| Uploadthing          | [`@hanzo/cms-storage-uploadthing`](https://github.com/payloadcms/payload/tree/3.x/packages/storage-uploadthing) |
| R2                   | [`@hanzo/cms-storage-r2`](https://github.com/payloadcms/payload/tree/3.x/packages/storage-r2)                   |

## Vercel Blob Storage

[`@hanzo/cms-storage-vercel-blob`](https://www.npmjs.com/package/@hanzo/cms-storage-vercel-blob)
...
[`@hanzo/cms-storage-s3`](https://www.npmjs.com/package/@hanzo/cms-storage-s3)
...
Cloudflare R2 exposes an S3-compatible API, so you can use `@hanzo/cms-storage-s3` to connect to it. This is the recommended approach when deploying to Vercel, Netlify, or any Node.js environment. (The `@hanzo/cms-storage-r2` adapter is for Cloudflare Workers only, where R2 is available as a native bucket binding.)
...
[`@hanzo/cms-storage-azure`](https://www.npmjs.com/package/@hanzo/cms-storage-azure)
...
[`@hanzo/cms-storage-gcs`](https://www.npmjs.com/package/@hanzo/cms-storage-gcs)
...
[`@hanzo/cms-storage-uploadthing`](https://www.npmjs.com/package/@hanzo/cms-storage-uploadthing)
...
[`@hanzo/cms-storage-r2`](https://www.npmjs.com/package/@hanzo/cms-storage-r2)
...
If you need to create a custom storage adapter, you can use the [`@hanzo/cms-plugin-cloud-storage`](https://www.npmjs.com/package/@hanzo/cms-plugin-cloud-storage) package. This package is used internally by the storage adapters mentioned above.
