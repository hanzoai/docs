...
import { SlateToLexicalFeature } from '@hanzo/cms-richtext-lexical/migrate'
...
import { migrateSlateToLexical } from '@hanzo/cms-richtext-lexical/migrate'
...
```ts
import type { SerializedUploadNode } from '@hanzo/cms-richtext-lexical'
import type { SlateNodeConverter } from '@hanzo/cms-richtext-lexical'
...
```ts
import type { SerializedLinkNode } from '@hanzo/cms-richtext-lexical'
import type { SlateNodeConverter } from '@hanzo/cms-richtext-lexical'
import { convertSlateNodesToLexical } from '@hanzo/cms-richtext-lexical/migrate'
...
```ts
import { convertSlateToLexical } from '@hanzo/cms-richtext-lexical/migrate'
...
```ts
import { upgradeLexicalData } from '@hanzo/cms-richtext-lexical'
