...
The `BlocksFeature` allows you to embed Payload's [Blocks Field](/docs/projects/hanzoai/cms/fields/blocks) directly inside your Lexical rich text editor. This provides a powerful way to create structured, reusable content components within your rich text content.
...
Blocks use the same configuration schema as Blocks within Payload's [Blocks Field](/docs/projects/hanzoai/cms/fields/blocks).
...
Your custom component can use composable primitives from `@hanzo/cms-richtext-lexical/client`. These components automatically receive block data from context, so you can use them to recreate the default block UI or arrange them in custom layouts:
...
```tsx
'use client'
import type { LexicalInlineBlockLabelClientProps } from '@hanzo/cms-richtext-lexical'
...
- [JSX Converters](/docs/projects/hanzoai/cms/rich-text/converting-jsx#lexical-blocks) - For React/Next.js applications
- [HTML Converters](/docs/projects/hanzoai/cms/rich-text/converting-html#blocks-to-html) - For static HTML output
- [Markdown Converters](/docs/projects/hanzoai/cms/rich-text/converting-markdown#defining-a-custom-block) - For markdown output
...
```ts
import { BlocksFeature, CodeBlock } from '@hanzo/cms-richtext-lexical'
