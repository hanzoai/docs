...
- [Converting JSX](/docs/projects/hanzoai/cms/rich-text/converting-jsx)
- [Converting HTML](/docs/projects/hanzoai/cms/rich-text/converting-html)
- [Converting Plaintext](/docs/projects/hanzoai/cms/rich-text/converting-plaintext)
- [Converting Markdown and MDX](/docs/projects/hanzoai/cms/rich-text/converting-markdown)

## Retrieving the Editor Config

Some converters require access to the Lexical editor config, which defines available features and behaviors. Payload provides multiple ways to obtain the editor config through the `editorConfigFactory` from `@hanzo/cms-richtext-lexical`.
...
import { editorConfigFactory } from '@hanzo/cms-richtext-lexical'
...
```ts
import { FixedToolbarFeature } from '@hanzo/cms-richtext-lexical'
...
```ts
import type { CollectionConfig, RichTextField } from @hanzo/cms'from 
