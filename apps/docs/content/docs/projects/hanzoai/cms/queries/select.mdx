...
With this feature, you can dramatically reduce the amount of JSON that is populated from [Relationship](/docs/projects/hanzoai/cms/fields/relationship) or [Upload](/docs/projects/hanzoai/cms/fields/upload) fields.
...
<Banner type="warning">
  **Important:** When using `defaultPopulate` on a collection with
  [Uploads](/docs/projects/hanzoai/cms/fields/upload) enabled and you want to select the `url` field,
