...
- [Local API](/docs/projects/hanzoai/cms/local-api/overview) - Extremely fast, direct-to-database access
- [REST API](/docs/projects/hanzoai/cms/rest-api/overview) - Standard HTTP endpoints for querying and mutating data
- [GraphQL](/docs/projects/hanzoai/cms/graphql/overview) - A full GraphQL API with a GraphQL Playground
