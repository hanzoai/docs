...
<Banner type="success">
  **Tip:** Localization works very well alongside
  [I18n](/docs/projects/hanzoai/cms/configuration/i18n).
</Banner>
...
to see how locales are auto-formatted, you can use the [GraphQL playground](/docs/projects/hanzoai/cms/graphql/overview#graphql-playground).
