...
If you only need to run one operation, use a single [Task](/docs/projects/hanzoai/cms/jobs-queue/tasks). But if you need multiple steps that depend on each other, use a Workflow.
