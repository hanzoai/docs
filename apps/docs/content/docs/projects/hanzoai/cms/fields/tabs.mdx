...
| Option              | Description                                                                                                                                                                                                                                                                                             |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`name`**          | Groups field data into an object when stored and retrieved from the database. [More details](/docs/projects/hanzoai/cms/fields/overview#field-names).                                                                                                                                                                        |
...
| **`interfaceName`** | Create a top level, reusable [Typescript interface](/docs/projects/hanzoai/cms/typescript/generating-types#custom-field-interfaces) & [GraphQL type](/docs/projects/hanzoai/cms/graphql/graphql-schema#custom-field-schemas). (`name` must be present)                                                                                            |
