...
- A "slider" with an image ([upload field](/docs/projects/hanzoai/cms/fields/upload)) and a caption ([text field](/docs/projects/hanzoai/cms/fields/text))
- Navigational structures where editors can specify nav items containing pages ([relationship field](/docs/projects/hanzoai/cms/fields/relationship)), an "open in new tab" [checkbox field](/docs/projects/hanzoai/cms/fields/checkbox)
- Event agenda "timeslots" where you need to specify start & end time ([date field](/docs/projects/hanzoai/cms/fields/date)), label ([text field](/docs/projects/hanzoai/cms/fields/text)), and Learn More page [relationship](/docs/projects/hanzoai/cms/fields/relationship)
...
| Option                 | Description                                                                                                                                                                                                                                                                          |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **`name`** \*          | To be used as the property name when stored and retrieved from the database. [More details](/docs/projects/hanzoai/cms/fields/overview#field-names).                                                                                                                                                      |
...
| **`validate`**         | Provide a custom validation function that will be executed on both the [Admin Panel](../admin/overview) and the backend. [More details](/docs/projects/hanzoai/cms/fields/overview#validation).                                                                                                           |
| **`minRows`**          | A number for the fewest allowed items during validation when a value is present.                                                                                                                                                                                                     |
| **`maxRows`**          | A number for the most allowed items during validation when a value is present.                                                                                                                                                                                                       |
| **`saveToJWT`**        | If this field is top-level and nested in a config supporting [Authentication](/docs/projects/hanzoai/cms/authentication/overview), include its data in the user JWT.                                                                                                                                      |
| **`hooks`**            | Provide Field Hooks to control logic for this field. [More details](../hooks/fields).                                                                                                                                                                                                |
| **`access`**           | Provide Field Access Control to denote what users can see and do with this field's data. [More details](../access-control/fields).                                                                                                                                                   |
| **`hidden`**           | Restrict this field's visibility from all APIs entirely. Will still be saved to the database, but will not appear in any API or the Admin Panel.                                                                                                                                     |
| **`defaultValue`**     | Provide an array of row data to be used for this field's default value. [More details](/docs/projects/hanzoai/cms/fields/overview#default-values).                                                                                                                                                        |
| **`localized`**        | Enable localization for this field. Requires [localization to be enabled](/docs/projects/hanzoai/cms/configuration/localization) in the Base config. If enabled, a separate, localized set of all data within this Array will be kept, so there is no need to specify each nested field as `localized`.   |
| **`required`**         | Require this field to have a value.                                                                                                                                                                                                                                                  |
| **`labels`**           | Customize the row labels appearing in the Admin dashboard.                                                                                                                                                                                                                           |
| **`admin`**            | Admin-specific configuration. [More details](#admin-options).                                                                                                                                                                                                                        |
| **`custom`**           | Extension point for adding custom data (e.g. for plugins)                                                                                                                                                                                                                            |
| **`interfaceName`**    | Create a top level, reusable [Typescript interface](/docs/projects/hanzoai/cms/typescript/generating-types#custom-field-interfaces) & [GraphQL type](/docs/projects/hanzoai/cms/graphql/graphql-schema#custom-field-schemas).                                                                                                  |
| **`dbName`**           | Custom table name for the field when using SQL Database Adapter ([Postgres](/docs/projects/hanzoai/cms/database/postgres)). Auto-generated from name if not defined.                                                                                                                                      |
| **`typescriptSchema`** | Override field type generation with providing a JSON schema                                                                                                                                                                                                                          |
| **`virtual`**          | Provide `true` to disable field in the database, or provide a string path to [link the field with a relationship](/docs/projects/hanzoai/cms/fields/overview#string-path-virtual-fields). See [Virtual Fields](https://payloadcms.com/blog/learn-how-virtual-fields-can-help-solve-common-cms-challenges) |
...
<Banner type="warning">
  ...
  [`validate`](/docs/projects/hanzoai/cms/fields/overview#validation) function on this Array field.
  [More details](/docs/projects/hanzoai/cms/database/indexes#unique-fields).
</Banner>
