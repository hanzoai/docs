...
| **`displayPreview`**   | Enable displaying preview of the uploaded file. Overrides related Collection's `displayPreview` option. [More details](/docs/projects/hanzoai/cms/upload/overview#collection-upload-options).                                                                                                                                |
...
Options can be dynamically limited by supplying a [query constraint](/docs/projects/hanzoai/cms/queries/overview), which will be used both
