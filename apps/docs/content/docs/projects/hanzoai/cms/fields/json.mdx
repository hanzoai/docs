...
| **`index`**            | Build an [index](/docs/projects/hanzoai/cms/database/indexes) for this field to produce faster queries. Set this field to `true` if your users will perform queries on this field's data often.                                                                                                                              |
