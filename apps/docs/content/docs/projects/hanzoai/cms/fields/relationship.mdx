...
| **`maxDepth`**         | Sets a maximum population depth for this field, regardless of the remaining depth when this field is reached. [Max Depth](/docs/projects/hanzoai/cms/queries/depth#max-depth)                                              |
...
| **`virtual`**          | Provide `true` to disable field in the database, or provide a string path to link the field with a relationship. See [Virtual Field Configuration](/docs/projects/hanzoai/cms/fields/overview#virtual-field-configuration) |
| **`graphQL`**          | Custom graphQL configuration for the field. [More details](/docs/projects/hanzoai/cms/graphql/overview#field-complexity)                                                                                                   |
...
Options can be dynamically limited by supplying a [query constraint](/docs/projects/hanzoai/cms/queries/overview), which will be used both for validating input and filtering available relationships in the UI.
...
You can learn more about writing queries [here](/docs/projects/hanzoai/cms/queries/overview).
