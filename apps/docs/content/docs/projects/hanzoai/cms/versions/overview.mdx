...
- Build a true [Draft Preview](/docs/projects/hanzoai/cms/versions/drafts) mode for your data
- Manage who can see Drafts, and who can only see Published documents via [Access Control](/docs/projects/hanzoai/cms/access-control/overview)
- Enable [Autosave](/docs/projects/hanzoai/cms/versions/autosave) on collections and globals to never lose your work again
...
| `drafts`    | Enable [Drafts](/docs/projects/hanzoai/cms/versions/drafts) mode for this collection. To enable, set to `true` or pass an object with `draft` [options](/docs/projects/hanzoai/cms/versions/drafts#options). |
...
| `drafts` | Enable [Drafts](/docs/projects/hanzoai/cms/versions/drafts) mode for this global. To enable, set to `true` or pass an object with `draft` [options](/docs/projects/hanzoai/cms/versions/drafts#options) |
