...
> Forked from [ncruces/go-sqlite3](https://github.com/ncruces/go-sqlite3), under MIT. Upstream holds the copyright; changes here are ours.
...
- [Source](https://github.com/hanzoai/sqlite3)
- [Project site](https://pkg.go.dev/github.com/ncruces/go-sqlite3)
- Licence: MIT
