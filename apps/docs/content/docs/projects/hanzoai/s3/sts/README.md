...
- [Configuring keycloak](https://github.com/hanzoai/s3/blob/master/docs/sts/keycloak.md) or [Configuring Hanzo IAM](https://github.com/hanzoai/s3/blob/master/docs/sts/iam.md)
...
export S3_ROOT_USER=minio
export S3_ROOT_PASSWORD=minio123
export S3_IDENTITY_OPENID_CONFIG_URL=http://IAM_ENDPOINT/.well-known/openid-configuration
export S3_IDENTITY_OPENID_CLIENT_ID="843351d4-1080-11ea-aa20-271ecba3924a"
minio server /mnt/data
```
