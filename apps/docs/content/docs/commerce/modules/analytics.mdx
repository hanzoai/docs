...
description: Commerce events, dashboards, and Datastore integration
icon: ChartBar
---

The Analytics module captures commerce events and stores them in Datastore for real-time dashboards, reporting, and business intelligence.
...
Events are written to Datastore for fast analytical queries:
...
analytics:
  enabled: true
  provider: datastore          # datastore | bigquery
  url: ${DATASTORE_URL}        # clickhouse://user:pass@host:9000/db
