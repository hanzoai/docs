...
services:
  commerce:
    ...
    environment:
      ...
      - S3_URL=s3://minioadmin:minioadmin@minio:9000/commerce
...
minio               Up                  9000/tcp, 0.0.0.0:9001->9001/tcp
...
Only expose the Commerce API port. Remove the MinIO console port:
...
services:
  ...
  # Remove minio port 9001 mapping
```
...
| `minio_data` | MinIO | Uploaded files, media |
