...
<Cards>
  <Card title="Docker" href="/docs/commerce/deployment/docker">
    Containerized deployment with compose.yml for Commerce, KV, Hanzo S3, and Hanzo Search
  </Card>
...
| Cache | Redis 7+ |
| Search | Hanzo Search or SQL FTS |
...
# Analytics (optional)
DATASTORE_URL=datastore://user:pass@host:9000/commerce   # Datastore for analytics
...
| `GET /health/ready` | Readiness check -- returns 200 when all dependencies (DB, KV) are connected |
