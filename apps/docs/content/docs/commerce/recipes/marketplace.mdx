...
import { H1, H2, XStack, YStack } from '@hanzo/gui'
...
export default async function VendorDashboard() {
  ...
  return (
    <YStack maxWidth={1100} width="100%" marginHorizontal="auto" padding="$4" gap="$6">
      <H1 size="$8">Vendor Dashboard</H1>
