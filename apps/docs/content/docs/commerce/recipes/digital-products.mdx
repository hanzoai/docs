...
import { Anchor, Card, H1, Paragraph, Text, YStack } from '@hanzo/gui'
  ...
  return (
    ...
    >
      ...
      {order.fulfillment.licenseKey && (
        <Card backgroundColor="$color2" borderRadius="$4" padding="$6" gap="$1">
      ...
      <YStack gap="$3">
        {order.fulfillment.downloads?.map((file) => (
          <Anchor key={file.filename} href={file.url} textDecorationLine="none">
            <Card bordered padding="$4" hoverStyle={{ backgroundColor: '$color2' }}>
