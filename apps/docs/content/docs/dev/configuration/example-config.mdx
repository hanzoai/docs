...
Use this example configuration as a starting point. For an explanation of each field, see [Configuration](./). Copy the snippet below to `~/.code/config.toml` and adjust values as needed.
