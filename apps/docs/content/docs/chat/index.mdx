---
title: Hanzo Chat
description: AI chat platform with 14 Zen models, 100+ third-party models, MCP tools, and agents. $5 free credit, prepaid billing from $0.30/MTok.
index: true
---
...
AI chat platform with **14 first-party Zen models**, **100+ third-party models**, built-in **MCP tool support**, and **configurable agents**. Available as a hosted service at [chat.hanzo.ai](https://chat.hanzo.ai) or self-hosted via Docker.
...
<Cards>
  ...
  <Card title="LLM Gateway" href="/docs/llm">
    Unified API proxy for all 200+ models
  </Card>
