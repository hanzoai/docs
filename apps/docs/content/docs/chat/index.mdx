...
Hanzo Chat is a production-ready AI chat platform. It ships **first-party Zen models** alongside **100+ third-party models** from OpenAI, Anthropic, Google, Meta, Mistral, Together, and Groq. Built-in MCP tool support, configurable agents, file uploads with RAG, vision, conversation history, presets, and plugins make it a complete chat solution.
