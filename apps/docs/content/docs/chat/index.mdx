...
<Cards>
  ...
  <Card icon={<LayoutGrid />} title="Integrations" href="/docs/guides/integrations" description="Connect blob storage, Slack, Mixpanel, and Insights to your project." />
