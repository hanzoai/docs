...
```bash
helm install chat oci://oci.hanzo.ai/charts/chat \
...
- [ ] Set up DocumentDB authentication
- [ ] Configure backup strategy for DocumentDB
...
| DocumentDB | 1 CPU, 1GB RAM | 2 CPU, 4GB RAM |
