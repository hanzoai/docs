...
| Agent | Model | Purpose |
|-------|-------|---------|
| Default | zen5 | General-purpose chat |
| Coder | zen5-coder | Code generation and review |
| Analyst | zen5-pro | Deep analysis and reasoning |
| Quick | zen5-flash | Fast responses for simple tasks |
