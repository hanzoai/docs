...
description: Introducing Hanzo Docs MDX, the official content source of Hanzo Docs.
icon: Album
---
...
<Cards>
  <Card title="Next.js" href="/docs/mdx/next">
    Using Hanzo Docs MDX with Next.js.
  </Card>
  <Card title="Vite" href="/docs/mdx/vite">
    Using Hanzo Docs MDX with Vite.
  </Card>
  <Card title="Runtime Loader" href="/docs/mdx/loader">
    Using Hanzo Docs MDX with a JavaScript runtime.
  </Card>
</Cards>
...
Hanzo Docs MDX uses [MDX Compiler](https://mdxjs.com/packages/mdx) to compile MDX files into JavaScript files.
