...
- [Agents](/docs/openapi/agents) — defining and running the agents that open these sessions
- [Automations](/docs/openapi/automations) — durable flows, including steps that wait for a person
- [Traces](/docs/openapi/o11y) — the recorded execution behind a run
