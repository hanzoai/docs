...
| **API Keys** (`sk-*`, `hz-*`) | Project (within an org) |
...
When using API keys (`sk-*`), the organization is determined by the project the key belongs to. No additional header is needed.
