...
The Rust binding is the reference ZAP implementation with full async support, post-quantum cryptography, and Corona consensus.
...
# Optional features
zap-proto = { version = "0.1", features = ["pq-tls", "corona", "did"] }
```
...
Enable the `corona` feature:

```toml
[dependencies]
zap-proto = { version = "0.1", features = ["corona"] }
```
...
- [zap-proto/rust](https://github.com/zap-proto/rust)
