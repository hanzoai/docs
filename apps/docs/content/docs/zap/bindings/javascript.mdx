...
```typescript
import { Zap, ClientInfo, ToolCall } from '@zap-proto/zap';
...
```typescript
import { ZapError, DisconnectedError, TimeoutError } from '@zap-proto/zap';
...
```typescript
import { Zap } from '@zap-proto/zap/browser';
...
```typescript
import { Server, ZapHandler } from '@zap-proto/zap/server';
import type {
  ClientInfo,
  ServerInfo,
  Tool,
...
Full examples at:
- [zap-proto/js](https://github.com/zap-proto/js)
