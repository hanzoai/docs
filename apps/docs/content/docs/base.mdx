...
curl -X POST https://acme-app.base.hanzo.ai/v1/collections \
...
curl "https://acme-app.base.hanzo.ai/v1/collections/posts/records?filter=(published=true)"
```

## Features

- Single-binary backend — SQLite-embedded for fast local dev, SQL in production
...
- [SQL](/docs/sql) — the managed SQL that backs production instances
