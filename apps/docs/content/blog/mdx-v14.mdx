...
We are pleased to announce Hanzo Docs MDX 14. This update introduces several major enhancements designed to:
...
Hanzo Docs MDX now generates multiple entry files in `.source` folder.
...
import { defineCollections, getDefaultMDXOptions } from '@hanzo/docs-mdx/config';
...
Thank you for your continued support of Hanzo Docs. If you encounter any issues during the update, welcome to reach out through our GitHub Discussions.
