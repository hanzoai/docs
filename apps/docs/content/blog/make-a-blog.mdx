...
Hanzo Docs is a docs framework, but it's also a powerful tool to manage content in Next.js. You can use Hanzo Docs to build a blog site along with docs, on a single Next.js app.

## Overview

This guide helps you build a blog site with Hanzo Docs and Hanzo Docs MDX.

We will use Hanzo Docs MDX to manage the content, and implement our own UI with Tailwind CSS & Hanzo Docs UI.
...
Colors like `text-fd-muted-foreground` are from the design system of Hanzo Docs UI, you may also use your own colors, or use Shadcn UI.
