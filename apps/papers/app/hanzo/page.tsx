...
export const metadata = {
  title: 'Hanzo AI',
  description: 'Research papers from Hanzo AI — AI infrastructure, commerce, and agent systems.',
};

export default function HanzoPage() {
  const org = getOrganization('hanzo');
  if (!org) notFound();
