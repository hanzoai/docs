...
<Tabs items={["Dashboard", "CLI", "API"]}>
  ...
  <Tab value="API">
    Volumes have no HTTP endpoint — use the console or the CLI above. The API at
    `https://api.hanzo.ai/v1/platform` covers projects, apps, env, deploys and
    domains; storage is not part of that surface.
  </Tab>
</Tabs>
