...
description: Generate text with any Zen model using the OpenAI-compatible chat completions endpoint
---
...
All Zen models work with this endpoint (except zen3-embedding which uses `/v1/embeddings`):
