...
[GITHUB](https://github.com/QwenLM/Qwen3-Embedding) [HUGGING FACE](https://huggingface.co/Qwen) [MODELSCOPE](https://modelscope.cn/organization/qwen) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
| Qwen3-Reranker-8B| 8B| 36| 32K| -| -| Yes  
 ...
 _Note: “MRL Support” indicates whether the embedding model supports custom dimensions for the final embedding. “Instruction Aware” notes whether the embedding or reranking model supports customizing the input instruction according to different tasks._
