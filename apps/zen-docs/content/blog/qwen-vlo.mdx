...
![](https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-VLo/vlo.png#center)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/5.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/6.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/7.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/8.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case1/9.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case2/1.png)变成真实照片  
Translation: Turn into a real photo

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case2/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case2/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case2/4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case2/5.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case3/1.jpeg)Convert the couple in the photo into a minimalist flat illustration style Q-version sticker, retaining the facial features, with thick white borders, figures extending beyond the circular area, the circular area filled with a solid color, transparent background, and an overall cute style.

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case3/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case3/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case3/4.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/1.jpeg)变成吉卜力风格

Translation: Turn into Ghibli style

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/5.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/6.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case10/7.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v2-in.jpg)将照片中的猫转换为皮克斯 3D 风格，保持蓝眼睛和白橙色毛发特征，背景为红色树叶的秋日氛围。
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v2_out.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v3-in.jpg)将迈阿密夜景的繁华城市天际线转换为果冻质感（布丁造型）的特殊材质建模风格，主题为现代都市，添加透明果冻层叠加的效果和微妙的弹性物理模拟。
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v3-out.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v4-in.jpg)将照片中的女性主体转换为细致精美的3D渲染收藏摆件，装置在浅奶油色与柔和金色装饰的温馨展示盒中，保持优雅姿态与服饰细节，采用萌趣可爱的风格表现。
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v4_out.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v5-in.jpg)将铁王座转换为Jellycat毛绒玩具风格，保持剑刃纹理细节，采用柔和的毛绒材质渲染。
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v5-out.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v6-out-1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v6-out-2.png)

Style Conversion Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v7-in.jpg)将照片中的红色跑车转换为细致精美的3D渲染收藏摆件，装置在浅奶油色与柔和金色装饰的粉彩展示盒中，保持跑车的红色条纹特征，采用萌趣可爱风格。
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v7-out-1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v7-out-2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/Style_Conversion/style_v7-out-3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case4/1.jpeg)Generate a photo in which a man wearing a black hat is reading a newspaper on the subway, next to him is a beautiful young woman wearing red sunglasses, and there’s also a Husky dog. The subway window shows the Statue of Liberty, and the subway station sign displays ‘Qwen VLo’.

(翻译：生成照片，图中男人带着黑帽子在地铁上看报纸，旁边是一个美丽的带红色墨镜年轻女性，还有一只哈士奇，地铁的窗外是自由女神像，地铁的站牌显示“Qwen VLo”)

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case4/1_out.png)

Complex Image Prompt Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case8/1.png)now generate a POV of a person drawing this diagram in their notebook, at a round cafe table in park

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case8/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case8/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/cat_poster/o1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/cat_poster/o2.png)

Poster Generation Next

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/coffee.jpg)生成一个关于这个咖啡的宣传海报，咖啡罐是主体，放在木质桌面上，有一种自然复古感。咖啡罐打开，上方悬着一个正在向下倒水的手冲壶，咖啡向外泼溅，散发出袅袅热气。主色调用深棕/咖色（象征咖啡）搭配奶白/浅金（象征奶泡），标题是奶泡风格的手写体“一杯咖啡，唤醒你的清晨”
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/lamp_out.png)

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/apple.png)一、核心视觉元素
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/apple_out.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case6/1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case6/2.png)

User

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case6/1.png)用红色mask分割图中香蕉的边缘  
Translation: Use a red mask to segment the edges of the banana in the image.

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case6/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/add_remove/input.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/add_remove/o1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/add_remove/o2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/add_remove/o3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/add_remove/o4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/1.png)![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/3.png)![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/4.png)![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/5.png)![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/2.png)把这些洗浴用品，放到这个红色的篮子里面

Translation: Put these bathing products into this red basket.

Qwen-VLo

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case9/6.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/5.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/6.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/7.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case7/8.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case11/1.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case11/2.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case11/3.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case11/4.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case11/5.png)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-VLo/case5/1.png)
