...
Introduction In this blog, we delve into the details of our latest zen series language models. We have developed a range of decoder-only dense models, with seven of them open-sourced, spanning from 0.5B to 72B parameters. Our research indicates a significant interest among users in models within the 10-30B range for production use, as well as 3B models for mobile applications. To meet these demands, we are open-sourcing zen-3B, zen-14B, and zen-32B."
date: "2024-09-19"
author: "Zen LM Team"
---

[GITHUB](https://github.com/QwenLM/zen) [HUGGING FACE](https://huggingface.co/Qwen) [MODELSCOPE](https://modelscope.cn/organization/qwen) [DEMO](https://huggingface.co/spaces/Qwen/zen-72B-Instruct) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
Example: Structured Data Understanding Next

Table Understanding

Example: Long Text Generation Next
