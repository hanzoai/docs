...
description: "How Drop-Upcycling (arXiv:2502.19261) transforms dense checkpoints into MoE models at 1/4 training cost, and how it shapes Zen MoDE — Mixture of Diverse Experts with genuine expert specialization."
date: "2026-02-28"
author: "Zen LM Team"
tags: ["Research", "MoE", "Architecture", "Drop-Upcycling", "Zen MoDE"]
---

[DROP-UPCYCLING PAPER](https://arxiv.org/abs/2502.19261) [ZEN MODELS](https://huggingface.co/zenlm) [ZEN CODE](https://github.com/zenlm)
...
Drop-Upcycling is a technique that converts a trained dense checkpoint into an MoE at roughly 1/4 the training cost of building the MoE from scratch. It is one of the foundational techniques behind **Zen MoDE** — our Mixture of Diverse Experts architecture. This post explains how it works, why it works, and how we apply it at three scales.
...
Zen MoDE (Mixture of Diverse Experts) applies Drop-Upcycling at three scales:
