...
[GITHUB](https://github.com/hanzoai) [HUGGING FACE](https://huggingface.co/hanzoai/zen4-ultra) [TRY ZEN CHAT](https://hanzo.ai/chat)

**Zen4 Ultra** is the most capable model in the Zen4 family. It is a Mixture of Diverse Experts (MoE) model with 480B total parameters and 35B active parameters per forward pass. The native context window is 256K tokens, extending to 1M tokens with YaRN extrapolation.
...
_Zen4 Ultra is available now on[Hugging Face](https://huggingface.co/hanzoai/zen4-ultra). For API access, see [hanzo.ai](https://hanzo.ai)._