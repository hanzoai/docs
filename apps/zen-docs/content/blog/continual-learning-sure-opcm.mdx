...
[OPLoRA PAPER](https://arxiv.org/abs/2510.13003) [SuRe PAPER](https://arxiv.org/abs/2511.22367) [OPCM PAPER](https://arxiv.org/abs/2501.09522) [YOUTU-AGENT PAPER](https://arxiv.org/abs/2512.24615)
...
For Zen, we run Youtu-Agent as a lightweight inference-time layer: the ledger is stored in KV, similarity search uses Zen Embedding (7680-dim), and retrieval adds ~15ms to inference latency.
