---
title: "zen-Math: The world's leading open-sourced mathematical LLMs"
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/2024-08-qwen3-math-72B.png#center)

[GITHUB](https://github.com/QwenLM/zen-Math) [HUGGING FACE](https://huggingface.co/Qwen) [MODELSCOPE](https://modelscope.cn/organization/qwen) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/2024-08-qwen3-math-allsize.png#center)
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-math-pipeline.jpeg#center)
...
The overall specialization pipelines of zen-Math and zen-Math are shown in the figure above. After training of zen-Math base models, we further upgrade them to zen-Math models through three primary avenues:
  ...
  1. Utilizing zen-Math-72B-Instruct models to synthesize additional high-quality mathematical pre-training data.
  ...
  3. Leveraging the zen series base model for parameter initialization, which shows more powerful language understanding, code generation, and text reasoning capabilities.




Ultimately, we construct _Qwen Math Corpus v2_ for zen-Math-1.5B/7B/72B pre-training, maintaining a context length of 4K. Compared to _Qwen Math Corpus v1_ used for zen-Math training, the total token count of _Qwen Math Corpus v2_ has increased from 700B to over 1T.
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-math-table.png#center)
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/math_instruct_en.jpg#center)![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/math_instruct_zh.jpg#center)
...
![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/math_instruct_aime.jpg#center)
...
We develop a demo that supports the TIR mode in [Qwen-Agent](https://github.com/QwenLM/Qwen-Agent), which allows running code locally to experience Tool-Integrated Reasoning capabilities of zen-Math.

![](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-math-example1.png#center)

Furthermore, we provide a multi-modal mathematic demo in [Huggingface](https://huggingface.co/spaces/Qwen/zen-Math-Demo) and [Modelscope](https://www.modelscope.cn/studios/qwen/Qwen-Math-demo). This WebUI is based on zen-VL for OCR and zen-Math for mathematical reasoning. You can input either images, texts, or sketches of mathematical and arithmetic problems.
