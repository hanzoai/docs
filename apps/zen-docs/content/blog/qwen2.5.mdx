...
[GITHUB](https://github.com/QwenLM/zen) [HUGGING FACE](https://huggingface.co/Qwen) [MODELSCOPE](https://modelscope.cn/organization/qwen) [DEMO](https://huggingface.co/spaces/Qwen/zen) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
[zen LLM](https://qwenlm.github.io/blog/qwen3-llm) [zen-Coder](https://qwenlm.github.io/blog/qwen3-coder) [zen-Math](https://qwenlm.github.io/blog/qwen3-math)
...
![zen Specification](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen%20modelcard.001.jpeg)
...
![zen-72B Instruct Performance](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-72B-Instruct-Score.jpg)
...
![zen-72B Base Model Performance](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-72B-base.001.jpeg)
...
![Qwen-Plus Instruct Performance](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen-plus-instruct.001.jpeg)
...
![zen-32B Instruct Performance](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-32B-instruct_wturbo.001.jpeg)
...
![zen Small Model](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-small.jpg)
...
![zen-Coder Instruct Performance](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/coder-main.png)
...
![zen Math Performance Across All Sizes](http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/2024-08-qwen3-math-allsize.png)
