...
![](https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-Image/merge3.jpg#center)

[GITHUB](https://github.com/QwenLM/Qwen-Image) [HUGGING FACE](https://huggingface.co/Qwen/Qwen-Image) [MODELSCOPE](https://modelscope.cn/models/Qwen/Qwen-Image) [DEMO](https://modelscope.cn/aigc/imageGeneration?tab=advanced) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/aliyun.png#center%20)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/tongyi.png#center)The model accurately drew the left and right couplets and the horizontal scroll, applied calligraphy effects, and accurately generated the Yueyang Tower in the middle. The blue and white porcelain on the table also looked very realistic.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/book.png#center%20)In this example, the model not only accurately outputs “New Arrivals This Week”, but also accurately generates the cover text of four books: “The light between worlds”, “When stars are scattered”, “The slient patient”, and “The night circus”.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/six.png#center%20)In this case, the model needs to generate 6 submodules, each with its own icon, title, and corresponding introductory text. Qwen-Image has completed the layout.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/small.png#center%20)In this case, the paper is less than one-tenth of the entire image, and the paragraph of text is relatively long, but the model still accurately generates the text on the paper.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/long.png#center%20)You can see that the model has completely generated a complete handwritten paragraph on the glass plate.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/bi.png#center%20)As you can see, the model can switch between two languages at any time when rendering text.
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/s2.jpg#center%20)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen-Image/s3.jpg#center%20)
