...
who are they? ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/1_celebrity.jpeg)
...
Where is it in the picture? How did you recognize it? ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/Image_Case_1_2.jpeg)
...
Look at pictures and write a poem. ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/Image_Case_1_3.png)
...
Describe the image.![](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/Image_Case_1_4.png)
...
Locate the red car ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/2_car_input.jpeg)

Qwen-VL

The red car is located in the bottom right corner of the image. ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/2_car_output.png)

Example: Contextually Anchored Image Description Generation Next

User

What does the pointed news talk about? ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/2_news.jpeg)
...
The current vehicle speed is 150km/h. According to the picture, how should the vehicle operate? A. To accelerate B. Slow down C. Maintain the original speed D. Parking Choose an answer and give reasons. ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/2_drive.jpeg)
...
read the image and solve it step by step ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/3_1_math_cube.jpeg)
...
convert the process into a python code program ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/3_2_python_code.jpeg)
...
Spot a data point that stands out in these charts and what that implicates. Then produce a detailed markdown table for all the data shown. ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/3_3_data_chart.jpeg)
...
Look at this sequence of three shapes. What shape should come as the fourth shape? Explain your reasoning with detailed descriptions of the first shapes. ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/3_4_polygon_reasoning.jpeg)
...
explain the picture ![image](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/3_5_model_flow.jpeg)
...
规范格式输出图中所有文字![](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/4_text_information_1.jpeg)
...
A brief summary of the blog![](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/4_text_information_2.jpeg)
...
Now you can access Qwen-VL-Plus and Qwen-VL-Max through the Huggingface Spaces, the Qwen website, and Dashscope APIs.
  ...
  * Log in to the QianWen web portal at <https://tongyi.aliyun.com/qianwen>, and switch to “Image Understanding” mode to harness the latest Qwen-VL-Max capabilities.![](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/qwen_web.png#center)

  * Access the powerful APIs of Qwen-VL-Plus and Qwen-VL-Max through the Dashscope platform (<https://help.aliyun.com/zh/dashscope/developer-reference/vl-plus-quick-start>).![](http://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-VL/blog/dash_api.jpeg#center)
