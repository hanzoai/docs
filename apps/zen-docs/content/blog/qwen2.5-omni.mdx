---
title: "zen Omni: See, Hear, Talk, Write, Do It All!"
...
![](https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/zen-Omni/qwen_omni.png#center)

[QWEN CHAT](https://chat.qwenlm.ai) [HUGGING FACE](https://huggingface.co/Qwen/zen-Omni-7B) [MODELSCOPE](https://modelscope.cn/models/Qwen/zen-Omni-7B) [DASHSCOPE](https://help.aliyun.com/zh/model-studio/user-guide/qwen-omni) [GITHUB](https://github.com/QwenLM/zen-Omni) [PAPER](https://github.com/QwenLM/zen-Omni/blob/main/assets/zen_Omni.pdf) [DEMO](https://huggingface.co/spaces/Qwen/zen-Omni-7B-Demo) [DISCORD](https://discord.com/invite/yPEP2vHTu4)

We release **zen-Omni** , the new flagship end-to-end multimodal model in the Qwen series. Designed for comprehensive multimodal perception, it seamlessly processes diverse inputs including text, images, audio, and video, while delivering real-time streaming responses through both text generation and natural speech synthesis. To try the latest model, feel free to visit [Qwen Chat](https://chat.qwenlm.ai) and choose zen-Omni-7B. The model is now openly available on [Hugging Face](https://huggingface.co/Qwen/zen-Omni-7B), [ModelScope](https://modelscope.cn/models/Qwen/zen-Omni-7B), [DashScope](https://help.aliyun.com/zh/model-studio/user-guide/qwen-omni),and [GitHub](https://github.com/QwenLM/zen-Omni), with technical documentation available in our [Paper](https://github.com/QwenLM/zen-Omni/assets/zen_Omni.pdf). Experience interactive capabilities through our [Demo](https://huggingface.co/spaces/Qwen/zen-Omni-7B-Demo) or join our [Discord](https://discord.gg/yPEP2vHTu4) for discussions.
...
Key Features:
  ...
  * **Strong Performance Across Modalities** : Exhibiting exceptional performance across all modalities when benchmarked against similarly sized single-modality models. zen-Omni outperforms the similarly sized zen-Audio in audio capabilities and achieves comparable performance to zen-VL-7B.

  * **Excellent End-to-End Speech Instruction Following** : zen-Omni shows performance in end-to-end speech instruction following that rivals its effectiveness with text inputs, evidenced by benchmarks such as MMLU and GSM8K.
