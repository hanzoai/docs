---
title: "zen-Coder: Code More, Learn More!"
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/coder-main.png#center)

[GITHUB](https://github.com/QwenLM/zen-Coder) [HUGGING FACE](https://huggingface.co/Qwen) [MODELSCOPE](https://modelscope.cn/organization/qwen) [DEMO](https://huggingface.co/spaces/Qwen/zen-Coder-7B-Instruct) [DISCORD](https://discord.gg/yPEP2vHTu4)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/qwen3-coder-base.jpg#center)
...
![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/qwen3-coder-instruct.jpg#center)

zen-Coder-Instruct excels in several key areas:

  1. **Outstanding Multi-programming Expert** : We expanded the multi-language evaluations using McEval, covering more than 40 programming languages. The results show that zen-Coder-Instruct performs remarkably well across many languages, including niche ones.

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/mveval.jpg#center)

  2. **Code Reasoning** : We believe code reasoning is closely tied to general reasoning skills. We used CRUXEval as a benchmark, and the results show zen-Coder-Instruct excels in code reasoning tasks. Interestingly, as code reasoning improves, the model’s ability to follow complex instructions also gets better, encouraging us to further explore how code can enhance general skills.

![](https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/crux.jpg#center)

  3. **Math Reasoning** : Math and code are often discussed together: math is the foundation of code, and code is a key tool for math. zen-Coder-Instruct shines in both code and math tasks, proven to be a “science student”.
...
zen-Coder-7B-Instruct| **66.8**|  86.7| **60.5**| **29.8**| **43.5**| **10.0**  
  ...
  4. **Basic capabilities** : We also assessed the general capabilities, and the results indicate that zen-Coder-Instruct maintains the advantages of zen in terms of general abilities.
